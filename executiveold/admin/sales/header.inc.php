  ...
  <img id="collage" src="../images/Header-new_Homepage-Collage.png" width="1175" height="150" alt=Photo Collage" /></div>
    ...
    <div id="mainNav">
      ...
      <!-- End 4 columns container -->
      		...
      		<!--<li><a href="">Calculate<br>Goals</a>-->
		<li><a href="viewReps.php">View<br>Reps</a>
		<li><a href="viewDistributors.php">View<br>Dist</a>
		<li><a href="repSetup.php">Add<br>Rep</a>
		<li><a href="distributorSetupForm.php">Add<br>Dist</a>
		<li><a href="distributorSetupForm.php">Edit My<br>Account</a>
