...
?><!DOCTYPE HTML>
<title>Representative Setup | GreatMoods</title>
...
<?php include 'sidenav.php' ; ?>
	<div id="contentMain858">
		...
		To add additional Representative Salespeople, click Save/Add Representative button at the bottom.<br><br></div>
      
		<form class="distributor1" action="handleRepresentativeSetup.php" method="POST" name="distributor" enctype="multipart/form-data" onSubmit="return validate(this);">
		<h3>Contact Information</h3>
		<div>
			<label id="firmName" for="firmName"> Company Name<span class="required">*</span></label>
			<br><input type="text" size="132" maxlength="40" id="firmName" name="firmName">
		</div>
		<div>
		...
		<div>
			...
			<div>
				<label id="paypalemail" for="paypal" class="formSelect">Paypal ID (Email Address)
				<br><input id="paypalemail"type="text" name="paypalemail"></label>
			</div>
			<br>
			...
			<div>
				...
				<input type="submit" value="Save/Add Representative" />
