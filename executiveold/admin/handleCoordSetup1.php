	...
	**/
	...
	//if(isUniqueEmail($link, $table1, $email)) {
		...
		$query2 .= " VALUES('$company','$FName','$MName','$LName','$ssn','$address1','$address2','$city','$state','$zip','$email','$homePhone','$fbPage','$twitter','$linkedin', '$salesMan','$extPhone','$paypal','$who')";
                $query3 = "INSERT INTO $table3 (companyName, FName, MName, LName, ssn, address1, address2, city, state, zip, email, homePhone, fbPage, twitter, linkedin, salesPerson, workPhoneExt, bannerPath, distPicPath,setupID)";
		$query3 .= " VALUES('$company','$FName','$MName','$LName','$ssn','$address1','$address2','$city','$state','$zip','$email','$homePhone','$fbPage','$twitter','$linkedin', '$salesMan','$extPhone', '$banner','$distPic','$id')";
