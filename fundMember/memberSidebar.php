...
<div id="leftSideBar">
	<div class="profileimgcrop"><img src="http://greatmoods.com/<?php echo $myPic;?>" class="profilepic" alt="UPLOAD YOUR PROFILE PICTURE HERE!"></div>
  	...
  	<div id="socialmediaicons">
  		...
  		<a href="salesContact.php?group=<? echo $_SESSION['groupid'];?>"><i id="emailicon" class="fa fa-envelope-square" title="Email"></i></a>
  	</div>
  	...
  	<div id="accordion">
	  	 ...
	  	 <div>
		  	 <ul id="sideNav">
		  	    <li><a href="fundgettingstarted11.php?group=<?php echo $_SESSION['groupid']; ?>"><i class="fa fa-desktop navicon"></i> GreatMoods<br>Program Overview</a></li>
			    ...
			    <li><a href="salesContact.php?group=<?php echo $_SESSION['groupid']; ?>"><i class="fa fa-check navicon"></i> Get Started Today!<br>Contact Your Rep!</a></li>
		  	 </ul>
	  	 </div>
	...
	<ul id="sideNav">
		...
		if(!isset($_SESSION['authenticated']))
	            {
	               echo '<li><a href="membersite.php?group='.$_GET['group'].'"><i class="fa fa-home navicon"></i> Fundraiser Homepage</a></li>'; 
	            }
		  ?>   
	...
	if(isset($_SESSION['authenticated'])) {
		...
		<h4>Account Administration</h4>
	       	<ul id="sideNav">
	       		<li><a href="membersite.php?group='.$_SESSION['groupid'].'"><i class="fa fa-home navicon"></i> My Web Page</a></li>
	            	<!-- <li><a href="goalsAchievements.php" title=""><i class="fa fa-calculator navicon"></i> Goals & Achievements</a></li>-->
	             	...
	             	<li><a href="contacts.php" title="Account Home"><i class="fa fa-user navicon"></i>Add/Edit Contacts</a></li>  
