...
<head>
	<meta charset="UTF-8" />
	<title>Send Emails | Fundraising Group</title>
...
<div id="container">
	...
	<div id="mainContent">
		...
		<h2>View Family, Friends, and Business Contacts</h2>
					...
					<?php
						...
						if ($result_setup) {
							while ($row_setup = mysqli_fetch_assoc($result_setup)) {
								...
								$query_contacts = "SELECT * FROM orgContacts WHERE fundraiserID = '$loginid' ORDER BY orgFName ASC";
								...
								if ($result_contacts) {
									while ($row_contacts = mysqli_fetch_assoc($result_contacts)) {
										...
										<tr>
											<td><input id="fname" type="text" name="update_first" value="' . $contacts_FName . '" /></td>
											<td><input id="lname" type="text" name="update_last" value="' . $contacts_LName . '" /></td>
											<td><input id="title" type="text" name="update_title" value="' . $contacts_Title . '" /></td>
											<td><input id="loginemail" type="text" name="update_email" value="' . $contacts_Email . '" /></td>
											<td><input id="phone" type="text" name="update_phone" value="' . $contacts_Phone . '" /></td>
											
											<td><input type="submit" name="submit_update" value="Update" class="edit_contact" title="Update Changes to Contact"/></td>
											</form>';
										...
										echo '
											...
											<td><input type="submit" name="delete" value="X" class="edit_contact" title="Delete Contact" /></td>
											</form>
										</tr>';
					...
					<table class="subject_and_message sub_mes2">
						...
						<tr>
							...
							<td class="message_box">
								...
								<textarea class="message_box_input message_box_firefox_only" id="message" name="message" rows="10" placeholder="Type Additional Message Here" title="Type Additional Message Here"></textarea>
