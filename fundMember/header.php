...
<head>
	...
	<!--bootstrap helper js-->
	<script src="../helpers/js/bootstrap-formhelpers-phone.js"></script>
...
<div id="headerMain"> 
	<div id="bannerwrap"><a href="https://greatmoods.com"><img id="logo2" src="../newdeal/images/logo.png" alt="GreatMoods Logo"></a><img id="banner" src="../<?php echo $banner;?>" width="1024" height="150" alt="banner placeholder" /></div>
	   ...
	   <li class="lfborder"><a class="logintitle" href=#">My Account</a>
			...
			<?php
				if(!isset($_SESSION['LOGIN']) || $_SESSION['LOGIN'] == "FALSE") {
					echo '<form id="log" class="newloginform" action="../logInUser.php" method="post">';
					echo '<h5>sign in</h5>';
					echo '<input type="text" class="loginemail" name="email" id="user" value="" placeholder="email address">
						<br>';
					echo '<input id="password" type="password" class="loginpassword" name="password" value="" placeholder="password">
						<br>';
					echo '<input class="user redbutton" id="user" name="login" type="submit" value="sign in">';
					echo '</form>';
					echo '<p class="forgotpw"><a href="">Forgot Password?</a></p>';
					echo '</div>';   
				} 
