...
<header>
    <div class ="container-fluid">
       <div class="row-fluid" id="aboveNavElements">
          <a href="#"  id="accountIconMobile" class="hidden-lg hidden-md pull-right" id="accountIconMobile" role="button" data-toggle="modal" data-target="#login-modal"><i class="fa fa-user-circle fa-3x" aria-hidden="true"></i></a>

          <div id="headerImage" class="col-lg-3 col-lg-offset-0 col-md-1 col-sm-1" style="">
