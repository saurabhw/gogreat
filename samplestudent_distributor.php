...
<html>
<head>
<title>Sample Member Website | GreatMoods</title>
...
<div id="leftSideBarSample">
  <img src="<?php echo $contact_photo;?>" width="128" height="150" alt="student photo">
      <ul id="sideNavSample">
      <li><a href="samplestudent_distributor.php?group=<?php echo $_GET['group']; ?>"><em>Fundraiser<br>Homepage</em></a></li>
      <li>About Our Fundraiser</li>
      <li><a href="fundgettingstarted.php?group=<?php echo $_GET['group']; ?>">Getting Started<br>Training Tips,<br>Tools &amp; Forms</a></li>
      <li><a href="club_website_TQ_distributor.php?group=<?php echo $groupID; ?>"><em>View Main Fundraising Website</em></a></li>
    </ul>
</div>
  ...
  <div id="contentSample">
    ...
    <div class="slider">
      <ul id="mycarousel" class="jcarousel-skin-tango">
        ...
        <!--<li><a href="childrensCorner.php?group=<?php echo $_GET['group']; ?>"><img src="images/store24_slide.jpg" alt="Children's Corner" /></a></li>-->
