...
<?php include 'includes/fundSidebar.php'; ?><!-- columns md-2 lg-3 defined inside file -->
<div class="container">
    <div class="row-fluid">
...
<div id="memberSiteContent" class="container">
  ...
  <!--		<br>-->
    ...
    <div class="page-header">
	    <h1><? echo $groupName; echo'&nbsp;';  echo stripslashes($club_type); ?> Fundraiser</h1>
	</div>
          ...
          <div id="carousel-sample" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active">
                  <!--<img class="img-responsive center-block" src="<?php echo "../".$leader_photo;?>" alt="UPLOAD YOUR GROUP PICTURE HERE!">    THIS LINK IS NOT WORKING ALONG WITH MOST PHP. WOOO PHP. -_- -->
        ...
        <div class="col-xs-9 col-xs-offset-3 col-sm-push-0 col-sm-offset-2 col-sm-2 col-md-3 col-md-push-1 col-md-offset-1 col-lg-3">
        	<div id="thermo-wrap" class="">
                <div id="thermometer">
                    <div class="track">
                        <div class="goal">
                            <div class="amount"><?php echo $fgoal; ?> </div>
                        </div>
                        <div class="raised">
            ...
            <div class="img-thumbnail  pull-right col-xs-offset-6 col-xs-pull-4 col-xs-1 col-sm-pull-0 col-sm-offset-0 col-md-1 col-lg-1 col-md-offset-0"  style="width:130px;height:180px" >
             <div class="leaderimgcrop "><img src="../<?php echo $contact_pic;?>" class="img-responsive" alt="UPLOAD ANY PICTURE HERE!"></div>
	         <?
			if($capTitle2 != '')
			{
			  echo'<div class="contactinfo2">
  ...
  <?php include 'includes/fundFooter.php' ; ?>
