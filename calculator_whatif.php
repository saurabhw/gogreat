...
<body>
<div id="container">
  <?php include 'header_TQ.php'; ?>
  <?php include 'leftSidebarNavSetupMain.php' ; ?>
  <div id="content">
  <? echo $s_temp;?>
      ...
      <div id="redBar2">
        <table "width="100%" border="0" cellspacing="0" cellpadding="3" summary="Table shows grand total commissions from schools, churches and organizations">
          <tr>
            ...
            <th width="20%" class="grandTotal" ><input id="grandTotal" type="text" name="grandTotal" value="<?php echo "$grandTotal";?>" size="6"/></th><th width="20%" class="grandTotal" ><input id="save" type="submit" name="save" value="Save"/></th>
          </tr>
          </table>
      </div><!--end redBar2-->
      <div id="redBar3">    
