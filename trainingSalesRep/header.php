               ...
               <div id="headerArc">
                  <a href="./index.php"><img src="../images/GMlogo6.png" id="GMlogo" alt="GM Logo"   /></a> 
					...
					if(!isset($_SESSION['LOGIN']) || $_SESSION['LOGIN'] == "FALSE") {
						echo "<span style='position: relative; top: 20px;'>";
						echo '<form id="log" action="logInUser.php" method="post">';
						echo '<label id="user">user: </label><input type="text" name="enter your name" id="user" value=""><br />';
...
<li><a href="GreatMoodsSetupEditWebsite1.php">Setup/Edit<br/>Website</a></li>     
