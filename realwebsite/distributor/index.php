...
<div id="container">
  ...
  <div id="content">
    ...
    <div id="column1">
      <p><br>New quality opportunities in the Fundraising industry are hard to come by in this very difficult economy, until now. Today’s Facebook, Cell Phone and Social Media Generation want convenience, ease of use and speed which our GreatMoods Personalized Website Fundraising Program offers.</p>
      <p>Please take a few minutes to go through our website and evaluate the GreatMoods Program and Product; the financial opportunity will pleasantly surprised by what you learn and how easy it is to create a long-term and reward income.</p>
      <div id="leadBox">
        <div id="infoText">
          <div id="redBar1">
      ...
      <p>The GreatMoods Program can generate a six-digit income for you annually. It allows for year-round fundraising that will be ongoing and forever. Every individual Fundraising Account you set up is your account forever.  Get started and line your accounts up today!</p>
      <p>Combining your years of experience in fundraising with<br>our years of experience in software, consumer product design and distribution makes our business relationship a perfect fit.</p>
      ...
      <p>If you’re unfamiliar with working online, don’t worry; the GreatMoods team can do all the tech stuff for you.<br>If you get your Fundraising Organization to say yes and identify a couple kids to help with the setup, then it’s a done deal for everyone.</p>
    </div>
    <!--end column1-->
    ...
    <div id="pcaption">GreatMoods offers fundraising opportunities for schools, religious organizations, community organizations, and more. </div>
      ...
      <p id="redtxt">Getting started as our Distributor<br>is quick and easy: <a href="../sales/distributorSetupForm.php" title="Sign up now">Click Here</a></p>
    </div>
    <!--end column2--> 
