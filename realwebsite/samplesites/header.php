...
<link href="../../css/header2Styles.css" rel="stylesheet" type="text/css">
</head>
<body>
<div id="container">
  <div id="headerMain"> <a href="index.php"><img id="banner" src="../../images/header_LogoRedBackground.png" width="1024" height="150" alt="GreatMoods: Great Fundraising!" /></a>
    <img id="collage" src="../../images/samplewebsites/lincolnbanner.jpg" width="1024" height="150" alt=Photo Collage" />
	...
	<div id="mainNav">
      <ul id="menu">
        ...
        <li><a href="../setupEditWebsite/fundtype.php">Greatmoods<br/>
          Homepage</a></li>
      ...
      <!-- Begin 4 columns container -->
        <div class="col_1">
          ...
          <ul>
            <li><a href="../samplesites/sampleband.php">Band</a></li>
            <li><a href="#">BPA</a></li>
      ...
      <!-- End 4 columns Item -->
        <li><a href="../distributor/products.php">Gift Basket <br/>& Products</a></li>
		<li><a href="">Getting <br/>Started</a></li>
		<li><a href="../trainingSalesRep/index.php" class="drop">Help </a>
		<div class="dropdown_4columns">	
			<div class="col_1">
