  ...
  <div id="headerMain"> <a href="index.php"><img id="banner" src="../../images/header_LogoRedBackground.png" width="1024" height="150" alt="GreatMoods: Great Fundraising!" /></a>
	...
	<div id="mainNav">
      <ul id="menu">
        ...
        <li><a href="../main/index.php">Greatmoods<br>Homepage</a></li>
      ...
      <!-- Begin 4 columns container -->
        ...
        <div class="col_1">
          ...
          <ul>
            ...
            <li><a href="club_website_TQ.php?group=22">Athletic Equipment </a></li>
      ...
      <!-- End 4 columns Item -->
        <li><a href="../main/basketsproducts.php">Gift Baskets<br>& Products</a></li>
