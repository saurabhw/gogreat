	  ...
	  $conPicPath = "";
		...
		if(!is_image($tmpPic)) {
	     ...
	     if($conPhoto != '')
	     {
          ...
          $query = "INSERT INTO orgCustomers (first, last, companyname, relationship, gender, email, workPhone, address, apt, city, state, zip, fundMemberID,fundGroupID, image_path,repID, title)VALUES('$fname', '$lname', '$cname', '$type', '$tt','$email', '$phone', '$address1', '$address2', '$city','$state', '$zip', '$memberID', '$group', '$personalPicPath', '$rep','$tt')";
...
<body>
	  ...
	  <div class="container" id="addFriendFamilyContent" >
                    <div class="row-fluid">
                    ...
                    <div class ="col-md-9 col-md-push-1 col-lg-push-2">
                    <div class="table">
<br>
<div id="border">	
						...
						<hr style="border-color:#b8b8b8;">
                    			...
                    			<div class="interim-form">
                    				...
                    				<div id="row"> 
                    					...
                    					<input  style="width:200px;" id="fb" type="text" name="" value="" placeholder="www.facebook.com/user">
                    				</div> <!-- end row -->
                    				<br>
                    				<div id="row"> 
                    					<span style="line-height:35px;" id="hd_tw">&nbsp;Twitter</span>
                    					<input  style="width:200px;" id="tw" type="text" name="" value="" placeholder="www.twitter.com/user">
                    				</div> <!-- end row -->
                    				<br>
                    				<div id="row"> 
                    					<span style="line-height:35px;" id="hd_li">&nbsp;LinkedIn</span>
                    					<input  style="width:200px;" id="li" type="text" name="" value="" placeholder="www.linkedin.com/user">
                    				</div> <!-- end row -->
                    				<!--<div id="row"> 
