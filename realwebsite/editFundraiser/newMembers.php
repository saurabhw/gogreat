...
<div id="border">
		<form class="" action="addFundMember.php" method="Post" id="myForm" name="myForm" onsubmit="return validate();" onsubmit="return checkForm(this);" enctype="multipart/form-data">
			<div class="table">
				...
				<div class="row">
						<span style="line-height:40px;padding-left:15px;" id="hd_rp4">Representive:</span>
						<span style="line-height:40px;" id="hd_gmfr4">Fundraiser Account:</span>
						
					</div> <!-- end row -->
					
				<div class="row" style="padding-left:15px;">
					
			  <select style="padding-left:15px;" class="role4" name="rpid" id="rpid" onChange="fetch_select6(this.value);" required>
			     <option style="padding-left:10px;" value="">Select Representative</option>
			     <?
	...
	<br>
	<ul style="line-height:25px;" class="tab">
    ...
    <hr style="border-color:#b8b8b8;">
				...
				<div class="simpleTabs">
					...
					<div class="interim-form">
						<div class="interim-header"><h3>Member Contact Information</h3></div> <!-- group based off selected value above -->
						...
						<div class="row" style="padding-left:15px;"> <!-- titles -->									
						...
						<div class="row" style="padding-left:15px;"> <!-- inputs -->
					...
					<div class="interim-form">
						...
						<span style="margin-left:90px;" id="hd_cpassword">Confirm Password</span>
						</div> <!-- end row -->
						<div id="row"> <!-- inputs -->
					...
					<div class="interim-form" style="padding-left:15px;"> <!-- profile pic tab5 -->
    						<hr style="border-color:#b8b8b8;">
						<div class="interim-header"><h3 style="margin-left:-15px;">Profile Photo</h3></div>
						<div class="row"> 
     	...
     	<h1>Upload Members</h1>
          ...
          <h3>How To Add Multiple Members</h3>
			...
			<p class="nospace">Label your spreadsheet columns from left to right as follows:</p>
          	...
          	<span>4. </span><input type="file" name="file" required>
        	<input style="padding-left:15px;" type="submit" name="submit" value="Submit" class="redbutton">
	</form>
</div>
    </div>
