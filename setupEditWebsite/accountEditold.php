<?
   ...
   if(isset($_POST['submit'])){
	   ...
	   $hph = mysqli_real_escape_string($link, $_POST['phone1']);
  	...
  	if($result2 && $result4){
  	    //verify paypal email
  	    $sql5 = "SELECT * FROM user_info WHERE userInfoID = '$who'";
  	    $sqlResult = mysqli_query($link, $sql5)or die("MySQL ERROR: sql5 ".mysqli_error($link));
  	    $sqlRow = mysqli_fetch_assoc($sqlResult);
  	    $payMailInfo = $sqlRow['userPaypal'];
  	   /* 
  	    if($payMailInfo != "")
  	    {
...
<div id="container">
	...
	<div id="table">
        <form class="" action="accountEdit.php" method="post" id="myForm" name="myForm" onsubmit="return validate(this);" enctype="multipart/form-data">
							...
							<div class="row"> <!-- inputs -->
								...
								<input id="zip" type="text" name="zip" value="<?php echo $row['zip'];?>" maxlength="5" required>
										...
										<div class="row"> <!-- title -->
                            				...
                            				<div class="row">
     <input type="text" name="phone1" id="phone" value="<?php echo $hp;?>" maxlength="14" />            				
           <!--<input id="phone" type="text" name="phone" value="<?php echo $row['homePhone'];?>" maxlength="14">--><!--<input id="wphone2" type="text" name=""><input id="wphone3" type="text" name="">-->
			...
			<!--<div class="interim-form"> --><!-- account login tab -->
				...
				<div class="interim-form"> <!-- payment tab -->
					...
					<p>Please enter your new or existing PayPal information. All commissions are paid next day into your PayPal account. If you prefer, we can set up your PayPal account for you. Setup a PayPal Account Here: <a href="http://www.paypal.com/home">www.paypal.com</a></p>
					<div class="row"> <!-- title -->
						<span id="hd_ppemail">PayPal Email</span>
					</div> <!-- end row -->
					<div class="row"> <!-- input -->
						<input id="paypalemail" type="text" name="paypalemail" value="<? echo $pp;?>">
					</div> <!-- end row -->
					...
					<div class="row"> <!-- inputs -->
						<input id="ssn1" type="text" name="ssn1" value="<? echo $sn;?>"><!--<input id="ssn2" type="text" name="ssn2"><input id="ssn3" type="text" name="ssn3">-->
						<input id="ftin1" type="text" name="ftin1" value="<? echo $ftxin;?>"><!--<input id="ftin2" type="text" name="ftin2">-->
					...
					<h3>3. 1099 Form</h3>
					<p>Explanation about 1099 Form <a href="http://turbotax.intuit.com/tax-tools/tax-tips/Self-Employment-Taxes/What-is-an-IRS-1099-Form-/INF14810.html">here</a>.<br>
					Go here to get your official copy of a 1099 form:  <a href="http://www.irs.gov/uac/about-form-1099misc">www.irs.gov/uac/about-form-1099misc</a></p>
					<br>
					<h3>Representative Commission: 6%</h3>
				...
				<div class="interim-form"> <!-- social media tab4 -->
					...
					<!--<div class="row"> 
						<span id="hd_pn" title="Pintrest Username or Profile URL" placeholder="">Pintrest</span>
						<input type="url" id="pn" name="printrest" value="">
					</div>--> <!-- end row -->
					<!--<div class="row">
						<span id="hd_gp" title="Google+ Username or Profile URL" placeholder="">Google+</span>
