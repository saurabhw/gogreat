<?php
	...
	//get saved reasons
      ...
      $resultK = mysqli_query($link, $queryK)or die ("couldn't execute query.".mysqli_error($link));
...
<div id="border">
    ...
    <form action="<?php echo htmlspecialchars(basename($_SERVER['PHP_SELF'])); ?>" method="POST" name="reasons" enctype="multipart/form-data" id="" onSubmit="return validate(this);">
    <textarea style="width:250px;" name="description" cols="50" rows="5" id="description"><? echo $about;?></textarea>
