...
<div id="container">
      ...
      <div id="content">
          ...
          <h3></h3>
		<div class="table">
			<form class="" action="addBusinessAssociate.php" method="post">
							...
							<tr>
								<td id="td_1">
									<div class="tablerow"> <!-- title -->
										<input type="checkbox"><label>Use Same Address As Business</label><br>
										<input type="checkbox"><label>Use Alternate Address:</label>
									</div> <!-- end row -->
									<div class="tablerow"> <!-- title -->
										<span id="hd_address1">Address 1</span>
									</div> <!-- end row -->
									<div class="tablerow"> <!-- input -->
										<input id="address1" type="text" name="address2">
									</div> <!-- end row -->
								...
								<td id="td_2">
									...
									<div class="tablerow">
										<input id="wphone1" type="text" name="pphone" maxlength="10"><!--<input id="wphone2" type="text" name=""><input id="wphone3" type="text" name="">-->
