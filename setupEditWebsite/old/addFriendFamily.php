...
<!DOCTYPE html>
<head>
	<title>GreatMoods | Member Account</title>
</head>
...
<div id="container">
      ...
      <div id="content">
		...
		<div class="table">	
			<form action="addFriendFamily.php" method="POST" name="addnewcontact" enctype="multipart/form-data" onsubmit="return validateAddNewContact()">
				<!--<h3>--Option 1: Add One Friend or Family Supporter--</h3>-->
					...
					<div class="interim-form">
						...
						<div class="tablerow"> <!-- inputs -->
							...
							<input id="pname" type="text" name="nickname">
							<!--<select name="">
								<option value="">---</option>
