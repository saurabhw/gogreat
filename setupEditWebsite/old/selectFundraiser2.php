          ...
          <form name="fundraisingType" id="fundraisingType" method="post" action="information2.php" enctype="multipart/form-data">
          	...
          	<div id="graybackground50">
				...
				<div class="typesection colnobreak">
					...
					<input type="radio" name="fundtype" value="Camps" onClick="fetch_select14(this.value);"><label>Camps</label> <br>
				</div> <!-- end typesection-->
				...
				<div class="typesection colnobreak">
					...
					<input type="radio" name="t" value="Youth & Sports"  onClick="fetch_select13(this.value);"><label>Youth & Sports</label> <br>
