...
<head>	
	...
	<link rel="preload" href="//cdnjs.cloudflare.com/ajax/libs/jasny-bootstrap/3.1.3/css/jasny-bootstrap.min.css" as="style" onload="this.rel='stylesheet'">-->
	<!-- asynch css load -->
    		...
    		<div class="newlogin">
		        <?php
		            if(!isset($_SESSION['LOGIN']) || $_SESSION['LOGIN'] == "FALSE") {
		                ...
		                echo '<input id="loginemail" type="text" name="email" value="" >';
		                echo '<br>';
		         	...
		         	echo '<span><a href="repLogin.php" />Login Home</a></span>';
