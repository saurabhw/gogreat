<?php  
	...
	**/
	...
	$query111 = "INSERT INTO user_info(companyName, address1, address2, city, state, zip, email, salesPerson, workPhone, bannerPath, role, dealer, user_table_id)";
      	...
      	'$userName', '$loginuser','$phone', '$bannerPicPath', '$role', 'Main Group', '$newClubID1')";
	...
	//insert parent group
	$newSQL1 = "INSERT INTO $table3 (Dealer, DealerDir, Phone, Address1, Address2, City, State, Zip,Banner, sponsorid, setuppersonid, signuptype, orgtype, demo, email, website, leader_pic, location_pic, group_team_pic, contact_pic, userName, banner_path, firstPass, isMainGroup, clubType) VALUES ( '$groupName', 'Main Group', '$phone','$address1','$address2','$city','$state','$zip', '$realBanner', '$parentID', '$loginuser','$type',
'$neworgtype', '$user_id', '$contactEmail','$url', '$realLeaderPic', '$realGroupPic', '$realCollagePic', '$realStudentPic', '$userName', '$realBanner', '$loginPass1', 1, '$club_type2')";
	...
	$newClubID = $row19['userID']; 	
      	...
      	'$userName', '$loginuser',  '$phone', '$bannerPicPath', '$role', '$optionArray[$i]', '$newClubID')";
	...
	$query4 = "INSERT INTO $table3 (Dealer, DealerDir, Phone, Address1, Address2, City, State, Zip, Banner, sponsorid, setuppersonid, signuptype, orgtype,  demo, email, website, leader_pic, location_pic, group_team_pic, contact_pic, userName, banner_path, firstPass, clubType) VALUES ( '$groupName', '$optionArray[$i]', '$phone','$address1','$address2','$city','$state','$zip', '$realBanner', '$parentID', '$loginuser','$type',
'$neworgtype', '$user_id', '','$url', '$realLeaderPic', '$realGroupPic', '$realCollagePic', '$realStudentPic', '$userName', '$realBanner', '$loginPass', '$club_type2')";
   ...
   if (isset($_POST['clubs1'])) 
	...
	$newClubID = $row19['userID']; 	
      	...
      	$query1 = "INSERT INTO user_info(companyName, address1, address2, city, state, zip, email, salesPerson, workPhone, bannerPath, role, dealer, user_table_id)";
      	$query1 .= "VALUES('$groupName', '$address1', '$address2', '$city', '$state', '$zip',
      	'$userName', '$loginuser',  '$phone', '$bannerPicPath', '$role', '$other', '$newClubID')";
	...
	$query4 = "INSERT INTO $table3 (Dealer, DealerDir, Phone, Address1, Address2, City, State, Zip, Banner, sponsorid, setuppersonid, signuptype, orgtype,  demo, email, website, leader_pic, location_pic, group_team_pic, contact_pic, userName, banner_path, firstPass, clubType) VALUES ( '$groupName', '$other', '$phone','$address1','$address2','$city','$state','$zip', '$realBanner', '$parentID', '$loginuser','$type',
...
'$neworgtype', '$user_id', '','$url', '$realLeaderPic', '$realGroupPic', '$realCollagePic', '$realStudentPic', '$userName', '$realBanner', '$loginPass', '$club_type2')";
   ...
   if (isset($_POST['athletics'])) 
	...
	$query4 = "INSERT INTO $table3 (Dealer, DealerDir, Phone, Address1, Address2, City, State, Zip, Banner, sponsorid, setuppersonid, signuptype, orgtype,  demo, email, website, leader_pic, location_pic, group_team_pic, contact_pic, userName, banner_path, firstPass, clubType) VALUES ( '$groupName', '$optionArrayx[$i]', '$phone','$address1','$address2','$city','$state','$zip', '$realBanner', '$parentID', '$loginuser','$type',
'$neworgtype', '$user_id', '','$url', '$realLeaderPic', '$realGroupPic', '$realCollagePic', '$realStudentPic', '$userName', '$realBanner', '$loginPass', 'Athletics')";
