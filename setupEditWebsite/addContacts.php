...
<head>
<meta charset="UTF-8">
<title>Add Contacts | Representative</title>
...
<div id="container">
    ...
    <p>Enter contact information for your fundraiser leaders. (Required Fields<span class="required">*</span>)</p>
    ...
    <div id="bannertable">
        <form id="graybackground5" action="" method="POST" name="fundraisercontacts" enctype="multipart/form-data" >
	        ...
	        <div id="row">
		          ...
		          <input id="redbutton" type="submit" name="submit" value="Save New Contacts" />
		          <a href="contacts.php?group=<? echo $group; ?>"><input id="redbutton" type="submit" name="submit" value="Back to Leader Contacts" /></a>
		</div> <!-- end row -->
        </form>
        </div> <!-- end table -->
        <br>
