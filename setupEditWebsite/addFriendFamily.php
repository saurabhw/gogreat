	  ...
	  $conPicPath = "";
		...
		if(!is_image($tmpPic)) {
	     ...
	     if($conPhoto != '')
	     {
          ...
          $query = "INSERT INTO orgCustomers (first, last, companyname, relationship, gender, email, workPhone, ext, address, apt, city, state, zip, fundMemberID,fundGroupID, image_path, repID, title)VALUES('$fname', '$lname', '$cname', '$type', '$gd','$email', '$phone', '$ext', '$address1', '$address2', '$city','$state', '$zip', '$memberID', '$groupID', '$personalPicPath', '$userID', '$tt')";
...
<body>
 ...
 <div class="page-header">
          <h2 align="center">Add Friend & Family</h2>
</div>
...
<div id="border">
			<form class="" action="addFriendFamily.php" method="post" id="myForm" name="myForm" onsubmit="return(validate());" enctype="multipart/form-data">
				...
				<div class="row">
					...
					<hr style="border-color:#b8b8b8;">
						<div id="row" style="margin-left:2px;"> 
						...
						<div id="row" style="margin-left:2px;"> 
							...
							<input style="width:200px;" id="tw" type="text" name="twt" value="" placeholder="www.twitter.com">
						</div> <!-- end row -->
						<br>
						<!--<div id="row" style="margin-left:2px;"> 
			...
			<br>
				<div class="row" style="margin-left:2px;">
					<input type="submit" name="submit" class="redbutton" value="Save Contact">
