<?php
	  ...
	  $user_page = "../membersite.php?group=";
		...
		$query2 .= " VALUES('$dealer','$fname','$mname','$lname','$ssn','$ad1','$ad2',  '$city','$state','$zip','$email','$phn','$face','$twt', '$userID','$phn',  '$payMail','$role', '$dealerdir', 'fundLeader', '$com', '$tt', '$gd')";
       ...
       //insert Dealer
		...
		$query3 .= " VALUES('$dealer','$dealerdir','$about','$reason','$goal','$start','$endz', '$address1', '$address2', '$ct','$st','$zp','$payMail','$banner', '$club_id','$userID', '$sponsorID', '$signupType', '$orgType', '$email','$url','$face', '$twt','$leaderPic', '$locationPic', '$groupPic', '$email', '$banner','$pass')";
		...
		if($res1 && $res2 && $res3){
			...
			mysqli_query($link, $query10);
		        ...
		        $queryH = "INSERT INTO orgMembers(Title,orgFName, orgLName, orgEmail, orgPhone,orgRel, fundraiserID, fund_owner_id, repID, isLeader, scID, vpID)VALUES('$tt', '$fname','$lname','$email','$phn', '$role', '$logID','$club_id', '$repID', '1', '$scID', '$vpID')";
		        $resultH = mysqli_query($link, $queryH)or die ("couldn't execute query h.".mysqli_error($link));
		     
		     		//insert leader table.
	$leaderInsert1 = "INSERT into leaders(user_info_id, fundID, repID, email)VALUES('$newUserID ', '$club_id', '$userID', '$email' )";
     ...
     */
	  ...
	  else
	  {
		...
		$query15 .= "VALUES('$dealer', '$dealerdir', '$about', '$reason', '$goal', '$start', '$endz', '$address1', '$address2', '$ct', '$st', '$zp', '$payMail', '$banner', '$club_id', '$userID', '$sponsorID', '$signupType', '$orgType', '$foundUser', '$email', '$url', '$face', '$twt', '$leaderPic', '$locationPic', '$groupPic', '$foundPic', '$email', '$banner', '$pass')";
