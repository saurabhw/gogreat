...
$link = connectTo();
  ...
  // $who = mysqli_real_escape_string($link, $_POST['clubidemail']);
   ...
   $message = "You have a new account and fundraising website at GreatMoods!<br>";
   $message .= "Check out your site: <br>http://www.greatmoods.com/fundMember/membersite.php?group=".$memberID;
   $message .= "<br>Login in to manage your account.<br>";
...
<body>
	...
	<div class="graybackground">
	          <form method="post" action="emailSend.php" enctype="multipart/form-data">
		         ...
		         <div id="emailmessage"><? echo $message; ?></div>
