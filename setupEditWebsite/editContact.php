...
<div id="container">
    ...
    <h2 align="center">Edit Fundraiser Contact</h2>
 
    
     <form method="post" id="myForm" name="myForm" action="<?php echo htmlspecialchars(basename($_SERVER['PHP_SELF'])); ?>" onsubmit="return validate();" enctype="multipart/form-data">
     	<div class="table">
		...
		<div class="interim-form">
			...
			<div class="row"> <!-- inputs -->
				...
				<select id="gender" name="gender">
					<option value="<? echo $gnd; ?>"><? echo $gnd; ?></option>
			...
			<table>
				<tr>
					<td id="td_1">
						...
						<div class="row"> <!-- input -->
							<input id="address1" type="text" name="address1" value="<? echo $ad1;?>" required>
						</div> <!-- end row -->
						...
						<div class="row"> <!-- inputs -->
							<input id="city" type="text" name="city" value="<? echo $cty;?>" required>
							...
							<input id="zip" type="text" name="zip" maxlength="5" value="<? echo $zp;?>" required>
						</div> <!-- end row -->
						<div class="row"> <!-- titles -->
		...
		<div class="interim-form"> <!-- profile pic tab4 -->
			<div class="interim-header"><h3>Contact Photo</h3></div>
			<div class="row"> 
