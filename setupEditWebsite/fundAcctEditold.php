...
<div id="container">
	...
	<?php include 'sideLeftNav.php' ; ?>
      ...
      <div id="content">
	<h1>Edit Fundraising Account Information</h1>
	<br>
	<form class="" action="fundAcctEdit.php" method="post" id="myForm" name="myForm" onsubmit="return validate();" enctype="multipart/form-data">
	<div class="table">
      		<div class="interim-form">
			<div class="interim-header"><h2>Contact Information</h2></div>
			<div class="row">
				<span id="hd_frname"><?echo $group_name;?>&nbsp;Name</span>
			</div> <!-- end row -->			
			<div class="row">
		...
		<div class="interim-form">
			<div class="interim-header"><h2>Website</h2></div>
				<div class="row">
					<span id="hd_url"><?php echo $orgName; ?>'s<br>Existing Website URL</span>
				</div> <!-- end row -->
				<div class="row">
					<input id="url" name="websiteURL" type="url" maxlength="250" value="<? echo $url; ?>" placeholder="include http://">
				</div> <!-- end row -->
				
				<div class="row">
					<span id="hd_banner"><?echo $orgName;?>'s Banner</span>
				</div> <!-- end row -->
				<div class="row">
               ...
               <div class="interim-form">
               		...
               		<span>Preview:</span>
			<img id="bannerPreview" src="../<?echo $current_banner;?>" alt="Current Banner" />
		</div>
         <br>
