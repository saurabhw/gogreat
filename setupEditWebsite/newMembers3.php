...
<div id="border">
<br>
      <ul class="tab" style="line-height:25px;">
			  ...
			  <select class="role4" name="rpid" id="rpid" onChange="fetch_select6(this.value);" required>
				...
				<div class="simpleTabs">
					...
					<div class="interim-form">
						...
						<span style="line-height:35px;margin-left:92px;" id="hd_cpassword">Confirm Password</span>
						</div> <!-- end row -->
						<div id="row" style="margin-left:2px"> <!-- inputs -->
				...
				<div id="row" style="margin-left:2px"><br> 
     	...
     	<h1>Upload Members</h1>
          ...
          <h3>How To Add Multiple Members</h3>
			...
			<p class="nospace">Label your spreadsheet columns from left to right as follows:</p>
          	...
          	<span style="line-height:35px;">4. </span><input style="margin-left:10px;line-height:35px;" type="file" name="file" required>
