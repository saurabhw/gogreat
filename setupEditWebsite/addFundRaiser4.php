...
$role = "fundOwner";
	...
	**/
	...
	$query4 = "INSERT INTO $table3 (Dealer, DealerDir, Phone, Address1, Address2, City, State, Zip, ContactName, setuppersonid, signuptype, orgtype, email, website, leader_pic, location_pic, group_team_pic, contact_pic, userName, banner_path, firstPass, clubType) VALUES ( '$groupName', '$optionArray[$i]', '$phone','$address1','$address2','$city','$state','$zip','$contactFirstName','$setup_person','$type',
'$neworgtype','$contactEmail','$url', '$groupLeaderPhoto', '$contactPhoto', '$groupPhoto', '$studentPhoto', '$userName', '$bannerPicPath', '$loginPass', '$clubType')";
   ...
   if($bannerPic != ''){
		$bannerPicPath = process_image('banner', $f_id, $orgLeaderPhoto, $imageDirPath);
		if($bannerPicPath !=''){
