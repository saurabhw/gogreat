...
<div id="container">
      ...
      <div id="content">
          ...
          <form class="form" action="addClub2.php" method="post" id="myForm15" name="myForm15" onsubmit="return atleast_onecheckbox(event);" enctype="multipart/form-data">
       
		<?
   if(isset($_POST['submit1']))
   {
      $clubID = $_POST['groupid'];
      $getGroup = "SELECT * FROM Dealers WHERE loginid = '$clubID'";
	...
	echo '<br><h3 style="display: inline;">'.$groupName.' '.$groupAddress.' '.$groupCity.' '.$groupState.' '.$z.'</h3><br><br>'; 
...
<div class="groupcolumns">
	...
	echo '<br> <span id="error"></span>
	<br><br>
	<input type="hidden" name="group" value="'.$clubID.'" ><input type="submit" name="submit" class="redbutton" value="Add New Clubs" />';
