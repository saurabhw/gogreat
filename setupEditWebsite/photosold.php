...
<div id="container">
    ...
    <div id="column1a">  
    	<form class="photos" action="photos.php" method="POST" name="addPhotos" enctype="multipart/form-data" onSubmit="return validate(this);">
          <div id="table">
          	<div class="row"> <!-- Leader bottom left pic -->
          		<h6><b>1.</b> Main Fundraiser Leader Photo</h6>
          		<span id="">Upload Photo:</span><br>
          	        <img src="../<?php echo $leader_pic; ?>" alt="Leader" width="200px" height="200px"><br>
          	...
          	<div class="row"> <!-- Member Leader bottom right pic -->
          		<h6><b>2.</b> Student or Other Fundraiser Leader Photo</h6>
          		<span id="">Upload Photo:</span><br>
          	       	<img src="../<?php echo $contact_pic; ?>" alt="Location" width="200px" height="200px"><br>
          	...
          	<div class="row"> <!-- Profile Pic in Left Nav -->
          		<h6><b>3.</b> Location or General Photo</h6>
          		<span id="longtext">Upload Photo:</span><br>
          		<img src="../<?php echo $location_pic; ?>" alt="Group" width="200px" height="200px"><br>
          		<input id="longtext" name="AddOrgGroupPhoto" type="file" title="Upload photo of the group/team fundraising">
          	</div> <!-- end row -->
          	
          	<br>
          	
          	<div class="row"> <!-- Banner at top of page -->
          		<h6><b>4.</b> Organization Banner</h6>
          		<span id="longtext">Upload Photo:</span><br>
          	    	<img src="../<?php echo $banner; ?>" alt="Banner" width="700px" height="150px"><br>
          	...
          	<div class="row"> <!-- Group/Collage in center of page -->
          		<h6><b>5.</b> Fundraising Group Photo or Collage</h6>
          		<span id="longtext">Upload Photo:</span><br>
          	    	<img src="../<?php echo $collage; ?>" alt="Collage" width="700px" height="150px"><br>
          	...
          	<div class="row"> 
          		...
          		<span id="longtext">Upload Video:</span><br>
   ...
   <div id="column2a">
   	<br>
      <img src="../images/photo_upload_examples.jpg" width="100%" alt="Example Layout of Photos">
