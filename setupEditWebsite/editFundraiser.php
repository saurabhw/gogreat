<?php 
      ...
      if($_SESSION['freeze'] == "TRUE")
       ...
       $check = checkChainRep($userID,$groupid);
        ...
        <div id="border">
            <table>
                <tr>
                    ...
                    <td>
                        <a href="../fundSite.php?group=<? echo $groupid;?>" target="_blank" ><input type="button" class="redbutton" value="View Members" /></a>
                        &nbsp;
                    </td>
                    <td>
...
<br>
	...
	<hr style="border-color:#b8b8b8;">
          		...
          		<span style="line-height:35px;" id="longtext">Upload Photo:</span><br>
          	    	<img class="img-responsive" src="../<?php echo $groupPic; ?>" alt="Banner" width="700px" height="150px"><br>
