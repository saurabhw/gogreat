...
<div id="leftSideBar">
	<div id="acctname">Welcome<br><? echo $_SESSION['firstName']; ?>!</div>
               <ul id="sideNav">
                     ...
                     <li><a href="calculator.php">Calculate Sales Goals</a></li>
                     ...
                     <hr>
                     <li><a href="information.php?group=<?echo $_GET["group"];?>">Edit Account Information</a></li>
                     ...
                     <li><a href="contacts.php?group=<?echo $_GET["group"];?>">Leader Contacts</a></li>
                     <!--<li><a href="addContacts.php?group=<?echo $_GET["group"];?>">Add Leader Contacts</a></li>-->
                     <li><a href="editMembers.php?group=<?echo $_GET["group"];?>">Members</a></li>
