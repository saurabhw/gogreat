<?php
 ...
 $link = connectTo();
  ...
  //$getGroup = "SELECT * FROM Dealers WHERE Dealer = '$q' AND Zip = '$z' AND setuppersonid = '$loginuser' AND isMainGroup = 1";
  $getGroup = "SELECT * FROM Dealers WHERE loginid = '$y' ";
  ...
  $clubType = $gRow['clubType'];
	...
	echo '<br><br><h3 style="display: inline;">'.$g.' '.$groupAddress.' '.$groupCity.' '.$groupState.' '.$z.'</h3><br><br><hr style="border-color:#b8b8b8;">'; 
    echo '<div id="border">';
	 switch($groupType) {
                case "College":
		echo'<div class="interim-form"> 
			<div class="interim-header"><h3>Select College Groups to Setup</h3></div>
                                       
			<input type="checkbox" name="all" onClick="toggle(this)"><label>Select All Groups</label>
			<br><br>
			<div class="groupcolumns">
				<div class="groupsection">
					<span style="line-height:35px;" id="">Clubs & Organizations</span><br>
				...
				<div class="groupsection">
					<br>
					<span  style="line-height:35px;" id="">General</span><br>
					<div class="checkboxes">
				...
				<div class="groupsection2">
					<span style="line-height:35px;" id="">Athletics</span><br>
					<div class="checkboxes">
			...
			<div class="groupsection">
				...
				<div class="groupsection">
					...
					<div class="checkboxes">
						...
						<input type="checkbox" name="general[]" value="Projection, Audio, Video"><label>Projection, Audio, Video</label> <br>
						<input type="checkbox" name="general[]" value="Tablets, Laptops & PCs"><label>Tablets, Laptops & PCs</label> <br>
						<input type="text" class="group" name="general1" id="general1" id="general1" id="general1" value="" placeholder="Please type in the club" title="Other"> <br>
					</div> <!-- end checkboxes -->
				</div> <!-- end groupsection -->
				...
				<div class="groupsection2">
					...
					<div class="checkboxes">
						...
						<input type="checkbox" name="athletics[]" value="Water Polo"><label>Water Polo</label> <br>
						<input type="checkbox" name="athletics[]" value="Wrestling"><label>Wrestling</label> <br>
						<input type="text" class="group" name="athletics1" id="athletics11" id="athletics1" id="athletics1" value="" placeholder="Please type in the club" title="Other"> <br>
					</div> <!-- end checkboxes -->
				</div> <!-- end groupsection -->
			</div> <!-- end groupcolumns -->
		</div> <!-- end interim-form -->';
		...
		echo '<div class="interim-form"> 
			...
			<div class="groupcolumns">
				<div class="groupsection">
					<span style="line-height:35px;">Clubs & Organizations:</span>
					<div class="checkboxes">
						<input type="checkbox" name="clubs[]" value="4-H"><label>4-H</label> <br>
						<input type="checkbox" name="clubs[]" value="Band"><label>Band</label> <br>
						<input type="checkbox" name="clubs[]" value="Booster Club"><label>Booster Club</label> <br>
				...
				<div class="groupsection2">
					<span style="line-height:35px;">Athletics:</span>
					<div class="checkboxes">
						<input type="checkbox" name="athletics[]" value="Archery"><label>Archery</label> <br>
						<input type="checkbox" name="athletics[]" value="Badminton"><label>Badminton</label> <br>
						<input type="checkbox" name="athletics[]" value="Baseball"><label>Baseball</label> <br>
		...
		echo '<div class="interim-form"> 
			...
			<div class="groupcolumns">
				...
				<div class="groupsection">
					<br>
					<span style="line-height:35px;">General Needs:</span>
					<div class="checkboxes">
						<input type="checkbox" name="general[]" value="General"><label>General</label> <br>
						<input type="checkbox" name="general[]" value="After-School Program"><label>After-School Program</label> <br>
						<input type="checkbox" name="general[]" value="Athletic Equipment"><label>Athletic Equipment </label> <br>
		...
		// switch($clubType)
		   // {
			...
			<div class="groupcolumns">
				...
				<div class="groupsection">
					<span style="line-height:35px;" id="">Missionary Funds</span><br>
					<div class="checkboxes">
		...
		case "Judaism":
		 switch($clubType)
		 {
			...
			<div class="groupcolumns">
				...
				<div class="groupsection">
					<span style="line-height:35px;" id="">Mission Trips</span><br>
					<div class="checkboxes">
						<input type="checkbox" name="clubs[]" value="All Missions"><label>All Missions</label> <br>
						<input type="checkbox" name="clubs[]" value="College Missions"><label>College Missions</label> <br>
		...
		switch($clubType)
		{
		   ...
		   case "Other Faiths":
		   echo '<div class="interim-form"> 
			<div class="interim-header"><h3>Select Faith to Setup</h3></div>
		...
		{  
		   ...
		   echo '<div class="interim-form"> 
			<div class="interim-header"><h3>Optomist International</h3></div>
...
<div class="groupcolumns">
		...
		case "Community Organizations":
			...
			<div class="groupcolumns">
				<div class="groupsection">
					<div class="checkboxes">
						<input type="checkbox" name="clubs[]" value="Local Food Shelves"><label>Local Food Shelves</label> <br><input type="text" class="group" name="clubs1" id="clubs1" value="" placeholder="Please type in the club" title="Other">
						 <br><input type="hidden" name="orgtype" value="Community Organizations">
					</div> <!-- end checkboxes -->
				</div> <!-- end groupsection -->
			</div> <!-- end groupcolumns -->
	...
	echo '<br> <input type="submit" name="submit" class="redbutton" value="Add New Clubs" /><br></div><!--end border-->';
