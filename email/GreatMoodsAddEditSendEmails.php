...
<link href="../css/addEditSendEmail.css" rel="stylesheet" type="text/css" />
	...
	<h1 class="setupEmail">Setup Email Contacts</h1>
		 <form id="setupEmail" action="addEmailContact.php" method="post">
                  ...
                  <td valign:"top">
                    ...
                    <form action="" method="post" name="personalizedList"/>
                    	<h4>Send Personalized Msg to:</h4><br/>
                        <input type="checkbox" name="sendTo[]" value='frinds'/>Friends<br/>
                        <input type="checkbox" name="sendTo[]" value='family'/>Family<br/>
                        <input type="checkbox" name="sendTo[]" value='both'/>Friends &amp; Family<br/>
                        <input type="checkbox" name="sendTo[]" value='individual'/>Individuals<br/>
