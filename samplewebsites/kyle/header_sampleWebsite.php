<link href="../css/headerSampleWebsiteStyles.css" rel="stylesheet" type="text/css">
  ...
  <ul id="menu">
    <li><a href="../index.php">GreatMoods<br/>Home</a></li>
    ...
    <li><a href="../trainingSalesRep/index.php">Training Tips,<br/>
      Tools &amp; Forms </a></li>
    <!-- End 4 columns Item --></ul>
  <div id="login">
<form id="log" action="logInUser.php" method="post">
<label class="user">username: </label><input type="text" name="enter your name" id="user" value="">
<label class="user">password: </label> <input type="password" name="password" id="password" value="" >
<input class="user" type="submit" value="login" />
     ...
     <?php
					if(!isset($_SESSION['LOGIN']) || $_SESSION['LOGIN'] == "FALSE") {
						...
						echo '<label class="user">username: </label><input type="text" name="enter your name" id="user" value="">';
                        echo '<label class="user">password: </label> <input type="password" name="password" id="password" value="" >';
                        echo '<input class="user" type="submit" value="login" /><br />';
                        echo '<p class="forgotpw"><a href="">Forgot Password?</a>&nbsp;  <a href="">Register</a></p><br />';
                        echo '</form></span>';
