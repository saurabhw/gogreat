...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->    
    <link href="newdeal/css/bootstrap.css" rel="stylesheet">      

    <!-- Custom styles for this template -->
<link href="newdeal/css/doc.css" rel="stylesheet">
	...
	<link rel="stylesheet" type="text/css" href="newdeal/css/jquery.fancybox.css" media="screen" /> 
	<link rel="stylesheet" type="text/css" href="newdeal/css/jPushMenu.css" /> 
  ...
  <noscript><link rel="stylesheet" href="newdeal/css2/bootstrap.css"></noscript><!-- load styles for browsers with JS disabled -->
  
  <link rel="preload" href="newdeal/css2/content_styles.css" as="style" onload="this.rel='stylesheet'"> <!-- asynch css load -->
  <noscript><linkrel="stylesheet" href="newdeal/css2/content_styles.css"></noscript><!-- load styles for browsers with JS disabled -->
  <!-- top navigation styles -->
  <link rel="preload" href="css2/main_nav.css" as="style" onload="this.rel='stylesheet'"> <!-- asynch css load -->
  <noscript><link rel="stylesheet" href="newdeal/css2/main_nav.css"></noscript><!-- load styles for browsers with JS disabled -->
...
<header class="header_sec">
	<div class="header_top">
		<div class="container">
			<div class="row">
				<div class="col-sm-12">
					<a class="navbar-brand" href="index.php"><img src="newdeal/images/logo.png" alt="" /></a>
	...
	<div class="header_menu">
		...
		<div class="top_menu visible-md visible-sm visible-xs">
			<button class="toggle-menu menu-left menu_btn">
				<img src="newdeal/images/menu_icon.png" alt="" />
			</button>
			...
			<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left">
				<ul class="nav navbar-nav" id="navCats"  id="mainCategoryType">
			      	<li class="dropdown">
		  ...
		  <div class="collapse navbar-collapse navbar-ex1-collapse">
		    ...
		    <div class="top_menu2">
		    	<div class="top_menu2_left">
		    		<span>fundraising examples </span>
		    		<ul>
		    			<li><a href="#">schools</a></li>
		    			<li><a href="#">organizations</a></li>
		    		</ul>
		    	</div>
		    	<div class="top_menu2_rt">
...
<section class="add_banner">
	<div class="add_banner_bg" style="background: url(newdeal/images/add_banner1.jpg) no-repeat 0 0;">
		<img src="newdeal/images/add_banner2.jpg" alt="" class="visible-xs" />
	</div>
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<div class="media">
				  <div class="media-left">
				    <img class="media-object" src="newdeal/images/mission_pic.png" alt="" />
				  </div>
				  <div class="media-body">
		...
		<div class="row">
			<div class="col-sm-12">
				<div class="footer_left">
					<a href="#"><img src="newdeal/images/logo.png" alt="" /></a>
				</div>
				<div class="footer_rt">
					<ul class="ftr_list">
