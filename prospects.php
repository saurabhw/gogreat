...
<div id="container">
  ...
  <div id="content">
    ...
    <h3>Fundraisers for Everyone</h3>
    <div id="column1">
      <p>GreatMoods has a wonderful variety of Gift Baskets for every occasion and customer or recipient. This makes for a perfect year-round Fundraiser because supporters can send them as gifts to Friends, Family Members, Business Customers and Clients. </p>
...
<li><a href="basketsproducts.php">Business Gift Baskets</a></li>
    ...
    <div id="column2">
    <div>
    	<img src="../../images/rep-pages/groupelem.png" width="404" height="270" alt="Kiwanis Club">
	<img class="imgLeft" src="../../images/rep-pages/soccerteam.png" width="198" height="166" alt="Young Girl">
	<img class="imgRight" src="../../images/rep-pages/church.png" width="198" height="166" alt="Boy with School Fundraiser">
    </div>
