<link href="css/headerStyles_TQ.css" rel="stylesheet" type="text/css">
                  ...
                  <a href="index.php"><img src="images/GMlogo6.png" id="GMlogo" alt="GM Logo"   /></a> 
                     <?php
                     	if(!isset($_SESSION['LOGIN']) || $_SESSION['LOGIN'] == "FALSE") {
                     	    ...
                     	    echo '<label id="user" for="user">Email: </label></td><td><input type="text" name="email" id="user" value=""><br />';
                     	    echo '<label id="password" for="password">Password: </label>';
                     	    echo '<input id="password" type="password" name="password" value="" ><br />';
                     	    echo '<input id="submit" name="submit" type="submit" value="login" />';
                     	    echo '<p class="user"><a href="recover.html">Forgot Password?</a>  <a href="">Register</a></p>';
                     	    echo '</form></span>';
...
<li><a href="setupEditWebsite2/selectFundraiser.php">Setup/Edit<br/>Website</a></li>     
<li><a href="distributor/index.php">Training Tips,<br/>Tools &amp; Forms </a></li>        
