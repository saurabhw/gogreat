<html>
	...
	<form action="modules/greatmoodslogin/Validate.php">
				
		<h1>Customer Account Setup</h1>
				
				<div class="simpleTabsContent currentTab" id="tabber23_div_0" >
					<h2>Information</h2>
					<div id="row"> <!-- titles -->
						...
						<span id="hd_pname">Preferred</span>
					...
					<div id="row"> <!-- inputs -->
					  ...
					  <input id="fname" type="text" name="" value="" title="First Name">
					  <input id="mname" type="text" name="" value="" title="Middle Name">
					  <input id="lname" type="text" name="" value="" title="Last Name">
					  <input id="pname" type="text" name="" value="" title="Preferred Name">
					  <input id="cname" type="text" name="" value="" title="Company Name">
					</div> <!-- end row -->
						
					<div id="row"> <!-- titles -->
						<span id="hd_mphone">
							<input type="radio" name="primary_phone" checked="">Mobile Phone
						</span>
						<span id="hd_hphone">
							<input type="radio" name="primary_phone">Home Phone
						</span>
						<span id="hd_wphone">
							<input type="radio" name="primary_phone">Work Phone
						</span>
						<span id="ext">Ext</span>
					</div> <!-- end row -->
					<div id="row"> <!-- inputs -->
					  <input id="mphone1" type="text" name="" value="">
					  <input id="mphone2" type="text" name="" value="">
					  <input id="mphone3" type="text" name="" value="">
						
						<input id="hphone1" type="text" name="" value="">
						<input id="hphone2" type="text" name="" value="">
						<input id="hphone3" type="text" name="" value="">
					...
					<div id="row"> <!-- inputs -->
						...
						<select id="day">
						  <option value="na" selected>Day</option>
					...
					<div id="row"> <!-- titles -->
					<span id="hd_address1">Address 1</span></div> 
					<!-- end row -->
					<div id="row"> 
					  <p>
					    <!-- inputs -->
				...
				<!--<div class="simpleTabsContent" id="tabber23_div_1" >-->
	  ...
	  <!--<div class="simpleTabsContent" id="tabber23_div_2">-->
	  ...
	  <!-- end simple tabs -->
			...
			</div><div><input type="submit" value="Register" id="submit_form_gms_vp_setup_gmfr"></input></div>
			</form>
