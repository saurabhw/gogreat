  ...
  <ul id="sideNavSample">
   ...
   <?
    ...
    <div class="contentp">
      ...
      <div><a href="#tab2-tab"><input type="button" value="Continue"/></a><a href="product_site.php?prodid=<?php echo $productid; ?>&group=<?php echo $_GET['group']; ?>"><input type="button" value="Continue Shopping"/></a></div>
      </div>-->
      
      <div class="sampletab" id="tab2"><img id="sampleimage" src="images/sample_sendtotab.PNG" width="842" height="390" alt="Send To"><br>
      <div><a href="#tab3-tab"><input type="button" value="To Personal Message"/></a><a href="product_site.php?prodid=<?php echo $productid; ?>&group=<?php echo $_GET['group']; ?>"><input type="button" value="Continue Shopping"/></a></div>
      </div>
      ...
      <div><a href="#tab4-tab"><input type="button" value="Review Order"/></a><a href="product_site.php?prodid=<?php echo $productid; ?>&group=<?php echo $_GET['group']; ?>"><input type="button" value="Continue Shopping"/></a></div>
      </div>
      ...
      <a href="product_site.php?prodid=<?php echo $productid; ?>&group=<?php echo $_GET['group']; ?>"><input type="button" value="Continue Shopping"/></a>
      </div>
