    ...
    <div id="column1">
      ...
      <div id="leadBox">
        <div id="infoText">
          ...
          <!--end redBar1-->
          <ul>
		<li>Fall & Holiday Gift Baskets (Thanksgiving, Hanukkah, Christmas)<br>A great gift item for Friends, Family, Business Customers & Clients</li>
		<li>Start the New Year with…. (Valentine’s Day, Easter, Mother’s Day, Father’s Day & Graduation)</li>
		<li>Special Occasions Coming Soon (Birthday, Anniversary, Baby & Wedding Showers)</li>
		<li>Themes (Coffee, Spa, Christian, Children’s & our new Fun Fashioned Boutique)</li>
		<li>Seasonal (Picnic, Friend & Family Game Night & Sports Themed)</li>
		<li>Business Gift Baskets are great for Customers & Clients<br>You can write anywhere from $5,000-$30,000 orders with your local banker, accountants, 			attorneys, real estate agents, co-ops & any small businessperson</li>
	</ul>
        </div>
        <!--end infoText--> 
      </div>
