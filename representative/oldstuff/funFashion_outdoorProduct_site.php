...
<div id="container">
   ...
   <!-- First Row -->
    <div class="productcol1">
      <div class="product">
        ...
        <a href="product_site.php?prodid=112&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item1.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=113&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item2.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=114&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item3.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=115&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item4.jpg" /></a>
      </div>
      <p></p>
    </div>
    <!-- End First Row -->
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product_site.php?prodid=116&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item5.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=117&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item6.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=118&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item7.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=119&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item8.jpg" /></a>
      </div>
      <p></p>
    </div>
    <!-- End Second Row -->
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product_site.php?prodid=120&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item9.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=121&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item10.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=122&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item11.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=123&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item12.jpg" /></a>
      </div>
      <p></p>
    </div>
  <!-- End Third Row -->
  ...
  <!-- Fourth Row -->
    <div class="productcol2">
      <div class="product">
        <a href="product_site.php?prodid=124&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item13.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=125&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item14.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=127&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item15.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=126&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-outabout_item16.jpg" /></a>
      </div>
      <p></p>
    </div>
  <!-- End Fourth Row -->
