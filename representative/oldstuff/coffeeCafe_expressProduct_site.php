...
<div id="container">
  ...
  <div id="contentSample">
    <h3>Coffee Cafe Express</h3>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=59&group=<?php echo $_GET['group']; ?>"><img src="images/coffee_item6.jpg" /></a>
      </div>
      <p>Morning Express</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=60&group=<?php echo $_GET['group']; ?>"><img src="images/coffee_item7.jpg" /></a>
      </div>
      <p>Latte To-Go</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=61&group=<?php echo $_GET['group']; ?>"><img src="images/coffee_item8.jpg" /></a>
      </div>
      <p>Coffee To-Go</p>
    </div>
