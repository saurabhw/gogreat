  ...
  <div id="contentSample">
    ...
    <div class="productcol1">
      <div class="product">
        ...
        <a href="product_site.php?prodid=148&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item1.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=149&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item2.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=150&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item3.jpg" /></a>
      </div>
      <p></p>
    </div>
   <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=151&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item4.jpg" /></a>
      </div>
      <p></p>
    </div>
    <!-- End First Row -->
    ...
    <div class="rightnav">
      ...
      <ul class="stumenu">
      <li><a href="jewelryGlitz_setProduct_site.php?group=<?php echo $_GET['group']; ?>">Necklace &amp; Earring Sets</a></li>
      <!-- <li><a href="jewelryGlitz_necklacesProduct_site.php?group=<?php echo $_GET['group']; ?>">Necklaces</a></li> -->
      <li><a href="jewelryGlitz_braceletsProduct_site.php?group=<?php echo $_GET['group']; ?>">Bracelets</a></li>
      <!-- <li><a href="jewelryGlitz_earringsProduct_site.php?group=<?php echo $_GET['group']; ?>">Earrings</a></li> -->
      <!-- <li><a href="jewelryGlitz_fashionsetsProduct_site.php?group=<?php echo $_GET['group']; ?>">Fashion Sets</a></li> -->
      <li><a href="jewelryGlitz_christianProduct_site.php?group=<?php echo $_GET['group']; ?>">Christian Corner</a></li>
      <!-- <li><a href="jewelryGlitz_holidayProduct_site.php?group=<?php echo $_GET['group']; ?>">Holiday Flair</a></li> -->
      </ul>
      <br>
    </div>
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product_site.php?prodid=152&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item5.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=153&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item6.jpg" /></a>
      </div>
      <p></p>
    </div>
        <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=154&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item7.jpg" /></a>
      </div>
      <p></p>
    </div>
        <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=155&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item8.jpg" /></a>
      </div>
      <p></p>
    </div>
    <!-- End Second Row -->
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product_site.php?prodid=156&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item9.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=157&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item10.jpg" /></a>
      </div>
      <p></p>
    </div>
        <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=158&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item11.jpg" /></a>
      </div>
      <p></p>
    </div>
        <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=159&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item12.jpg" /></a>
      </div>
      <p></p>
    </div>
    <!-- End Third Row -->
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product_site.php?prodid=160&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item13.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=161&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item14.jpg" /></a>
      </div>
      <p></p>
    </div>
        <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=162&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item15.jpg" /></a>
      </div>
      <p></p>
    </div>
        <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=163&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item16.jpg" /></a>
      </div>
      <p></p>
    </div>
    <!-- End Fourth Row -->
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product_site.php?prodid=164&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item17.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=165&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item18.jpg" /></a>
      </div>
      <p></p>
    </div>
        <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=166&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item19.jpg" /></a>
      </div>
      <p></p>
    </div>
        <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=167&group=<?php echo $_GET['group']; ?>"><img src="images/jewelry-neset_item20.jpg" /></a>
      </div>
      <p></p>
    </div>
    <!-- End Fifth Row -->
