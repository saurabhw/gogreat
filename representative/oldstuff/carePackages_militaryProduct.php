...
<div id="leftSideBarSample">
  ...
  <div id="contentSample">
    ...
    <div class="productcol1">
      <div class="product">
         <a href="product.php?prodid=85&group=<?php echo $_GET['group']; ?>"><img src="images/carepackage_item3.jpg" /></a>
      </div>
      <p>Candy Fever</p>
    </div>
    <div class="productcol1">
      <div class="product">
         <a href="product.php?prodid=81&group=<?php echo $_GET['group']; ?>"><img src="images/candy_item1.jpg" /></a>
      </div>
      <p>Sweets &amp; Treats</p>
    </div>
    <div class="productcol1">
      <div class="product">
         <a href="product.php?prodid=83&group=<?php echo $_GET['group']; ?>"><img src="images/candy_item3.jpg" /></a>
      </div>
   ...
   <!-- Begin right side navigation-->
    <div class="rightnav">
      ...
      <ul class="stumenu">
      <!--<li><a href="carePackages_familyProduct.php?group=<?php echo $_GET['group']; ?>">Family &amp; Friends</a></li> -->
      <li><a href="carePackages_militaryProduct.php?group=<?php echo $_GET['group']; ?>">Overseas/Military</a></li>
      <li><a href="carePackages_collegeProduct.php?group=<?php echo $_GET['group']; ?>">College Starter Kits</a></li>
      <li><a href="carePackages_schoolProduct.php?group=<?php echo $_GET['group']; ?>">Study Care Packages</a></li>
      </ul>
      <br>
    </div>
