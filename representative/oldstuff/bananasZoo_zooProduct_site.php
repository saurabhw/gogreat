...
<div id="container">
  ...
  <div id="contentSample">
    ...
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=71&group=<?php echo $_GET['group']; ?>"><img src="images/zoo_item1.jpg" /></a>
      </div>
      <p>Zainy's Zoo</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=72&group=<?php echo $_GET['group']; ?>"><img src="images/zoo_item2.jpg" /></a>
      </div>
      <p>Deano's Dinosaurs</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=73&group=<?php echo $_GET['group']; ?>"><img src="images/zoo_item3.jpg" /></a>
      </div>
    ...
    <div class="rightnav">
      ...
      <ul class="stumenu">
      <li><a href="bananasZoo_zooProduct_site.php?group=<?php echo $_GET['group']; ?>">Enter Zoo</a></li>
      <!--<li><a href="bananasZoo_zooProduct_site.php?group=<?php echo $_GET['group']; ?>">Zainy's Zoo</a></li>
      <li><a href="bananasZoo_dinosaurProduct_site.php?group=<?php echo $_GET['group']; ?>">Deano's Dinosaurs</a></li>
      <li><a href="bananasZoo_seaProduct_site.php?group=<?php echo $_GET['group']; ?>">Sunny's Sea Sensations</a></li>
      <li><a href="bananasZoo_forestProduct_site.php?group=<?php echo $_GET['group']; ?>">Furry's Forest Friends</a></li> -->
      </ul>
      <br>
    </div>
