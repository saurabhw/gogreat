...
<div id="tableWrapper">
  ...
  <table class="calculatorTable">
    ...
    <tr>
      ...
      <td>x
        <input type="text" id='Lmembers' name"" size="5" onchange='calculateChurch("L")'/></td>
      <td>x
        <input type="text" id='Lpercent' name"" size="5" onchange='calculateChurch("L")'/></td>
      <td>x
        <input type="text" id='Lbaskets' name"" size="5" onchange='calculateChurch("L")'/></td>
      <td>x $26.00</td>
      <td>x
        <input type="text" id='LfundPerYear' name"" size="5" onchange='calculateChurch("L")'/></td>
      <td> 10%</td>
      <td id='Ltotal'>= </td>
    </tr>
    <tr>
      ...
      <td>x
        <input type="text" id='Amembers' name"" size="5" onchange='calculateChurch("A")'/></td>
      <td>x
        <input type="text" id='Apercent' name"" size="5" onchange='calculateChurch("A")'/></td>
      <td>x
        <input type="text" id='Abaskets' name"" size="5" onchange='calculateChurch("A")'/></td>
      <td>x $26.00</td>
      <td>x
        <input type="text" id='AfundPerYear' name"" size="5" onchange='calculateChurch("A")'/></td>
      <td> x10%</td>
      <td id='Atotal'>= </td>
    </tr>
    <tr>
