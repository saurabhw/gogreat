...
<div id="container">
  ...
  <div id="contentSample">
    <h3>Spa Salon Selections</h3>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=43&group=<?php echo $_GET['group']; ?>"><img src="images/spa_item2.jpg" /></a>
      </div>
      <p>Spa Sensations</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=44&group=<?php echo $_GET['group']; ?>"><img src="images/spa_item4.jpg" /></a>
      </div>
      <p>Rejuvenation Sensation</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=45&group=<?php echo $_GET['group']; ?>"><img src="images/spa_item6.jpg" /></a>
      </div>
      <p>It's a Girl!</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=46&group=<?php echo $_GET['group']; ?>"><img src="images/spa_item7.jpg" /></a>
      </div>
      <p>It's a Boy!</p>
      </div>
    ...
    <div class="rightnav">
      <h3 class="mallHeader">Luxury Salon &amp; Spa </h3>
      <div class="productmallLinks">
      <ul class="stumenu">
      <li><a href="salonSpa_selectionsProduct_site.php?group=<?php echo $_GET['group']; ?>">Spa Salon Selections</a></li>
      <li><a href="salonSpa_hairnailProduct_site.php?group=<?php echo $_GET['group']; ?>">Hair &amp; Nail Salon</a></li>
      </ul>
      <br>
    </div>
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product_site.php?prodid=47&group=<?php echo $_GET['group']; ?>"><img src="images/spa_item8.jpg" /></a>
      </div>
      <p>Baby Bathtime</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=48&group=<?php echo $_GET['group']; ?>"><img src="images/spa_item9.jpg" /></a>
      </div>
      <p>Rub-a-Dub Duck</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=49&group=<?php echo $_GET['group']; ?>"><img src="images/spa_item10.jpg" /></a>
      </div>
      <p>Onsie-Twosie Bathtime Fun</p>
    </div>
  </div>  <!--end content-->
