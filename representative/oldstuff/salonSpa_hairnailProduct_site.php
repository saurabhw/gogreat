...
<div id="container">
  ...
  <div id="contentSample">
    ...
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=50&group=<?php echo $_GET['group']; ?>"><img src="images/spa_item1.jpg" /></a>
      </div>
      <p>A Moment For Me</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=51&group=<?php echo $_GET['group']; ?>"><img src="images/spa_item3.jpg" /></a>
      </div>
      <p>Primp, Pamper & Prep</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=52&group=<?php echo $_GET['group']; ?>"><img src="images/spa_item5.jpg" /></a>
      </div>
