...
<div id="container">
  ...
  <div id="contentSample">
    ...
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=82&group=<?php echo $_GET['group']; ?>"><img src="images/candy_item2.jpg" /></a>
      </div>
      <p>Snack Attack</p>
    </div>
    <div class="productcol1">
    ...
    <div class="rightnav">
      ...
      <ul class="stumenu">
      <li><a href="candyland_counterProduct_site.php?group=<?php echo $_GET['group']; ?>">The Candy Counter</a></li>
      <!--<li><a href="candyland_healthyProduct_site.php?group=<?php echo $_GET['group']; ?>">Healthy Treats &amp; Sweets</a></li> -->
      </ul>
      <br>
    </div>
