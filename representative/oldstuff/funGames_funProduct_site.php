...
<div id="container">
  ...
  <div id="contentSample">
    ...
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=68&group=<?php echo $_GET['group']; ?>"><img src="images/family_item1.jpg" /></a>
      </div>
      <p>Game Night</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=69&group=<?php echo $_GET['group']; ?>"><img src="images/family_item2.jpg" /></a>
      </div>
      <p>Shake, Rattle &amp; Roll</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=70&group=<?php echo $_GET['group']; ?>"><img src="images/family_item3.jpg" /></a>
      </div>
      <p>Game On</p>
    </div>
    ...
    <div class="rightnav">
      ...
      <ul class="stumenu">
      <li><a href="funGames_funProduct_site.php?group=<?php echo $_GET['group']; ?>">Fun &amp; Games</a></li>
      <li><a href="funGames_sillyProduct_site.php?group=<?php echo $_GET['group']; ?>">Silly Sports</a></li>
      </ul>
      <br>
    </div>
