...
<div id="leftSideBarSample">
  ...
  <div id="contentSample">
    <img src="images/store20.jpg" />
    <div class="categories">
    <h5>Happy, Hardy-Party Superstore Coming October 15th!</h5>
    <!--<ul class="categoriesul">
      <li><a href="coffeeCafe_giftProduct_site.php?group=<?php echo $groupID; ?>">Coffee Cafe Gifts</a></li>
      <li><a href="coffeeCafe_expressProduct_site.php?group=<?php echo $groupID; ?>">Express</a></li>
      <li><a href="coffeeCafe_ciderProduct_site.php?group=<?php echo $groupID; ?>">Cider &amp; Cocoa Concoctions</a></li>
      <li><a href="coffeeCafe_proteinProduct_site.php?group=<?php echo $groupID; ?>">Protein To-Go</a></li>
    </ul> -->
  </div>
  </div>  <!--end content-->
