...
<div id="container">
  ...
  <div id="contentSample">
    <h3>Coffee Cafe Cider &amp; Cocoa Concotions</h3>
    <div class="productcol1">
      <div class="product">
       <a href="product_site.php?prodid=62&group=<?php echo $_GET['group']; ?>"><img src="images/coffee_item9.jpg" /></a>
      </div>
      <p>Cocoa Comforts</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=63&group=<?php echo $_GET['group']; ?>"><img src="images/coffee_item10.jpg" /></a>
      </div>
      <p>Cocoa, Cocoa, Cocoa</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=64&group=<?php echo $_GET['group']; ?>"><img src="images/coffee_item13.jpg" /></a>
      </div>
      <p>Cinnamon Cider Sensations</p>
    </div>
