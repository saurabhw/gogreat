...
<div id="leftSideBarSample">
  ...
  <div id="contentSample">
    <h3>Biscuits, Bones &amp; Playtime Fun</h3>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=84&group=<?php echo $_GET['group']; ?>"><img src="images/pet_item1.jpg" /></a>
      </div>
      <p>Barney's Bounty<br>Playtime Fun</p>
    </div>
    
        <!-- Begin right side navigation-->
    <div class="rightnav">
      <h3 class="mallHeader">Barney's Pet Shop</h3>
      <div class="productmallLinks">
      <ul class="stumenu">
       <li><a href="barneysPet_biscuitsProduct_site.php?group=<?php echo $_GET['group']; ?>">Biscuits, Bones &amp; Playtime Fun</a></li>
      <!--<li><a href="barneysPet_struttingProduct_site.php?group=<?php echo $_GET['group']; ?>">Strutting My Stuff</a></li> -->
      </ul>
      <br>
    </div>
