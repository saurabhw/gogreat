...
<div id="leftSideBarSample">
  ...
  <div id="contentSample">
    ...
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=86&group=<?php echo $_GET['group']; ?>"><img src="../images/carepackage_item1.jpg" /></a>
      </div>
      <p>Dorm Starter Kit</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=87&group=<?php echo $_GET['group']; ?>"><img src="../images/carepackage_item2.jpg" /></a>
      </div>
