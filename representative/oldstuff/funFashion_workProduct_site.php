...
<div id="container">
  ...
  <div id="contentSample">
    <h3>Designer Work Wear</h3>
    <!-- First Row -->  
    <div class="productcol1">
      <div class="product">
        <!-- Replace "fashion_item1.jpg" with appropriate image title -->
        <a href="product_site.php?prodid=103&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-work_item1.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=104&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-work_item2.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=105&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-work_item3.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=106&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-work_item4.jpg" /></a>
      </div>
      <p></p>
    </div>
    <!-- End First Row -->
    ...
    <div class="rightnav">
      ...
      <ul class="stumenu">
      <li><a href="funFashion_scarvesProduct_site.php?group=<?php $groupID = $_GET['group']; echo $groupID; ?>">Scarves, Scarves, Scarves</a></li>
   ...
   <h3 class="mallHeader">GreatMoods Mall Directory</h3>
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product_site.php?prodid=107&group=<? echo $groupID; ?>"><img src="images/fashion-work_item5.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=108&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-work_item6.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=109&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-work_item7.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=110&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-work_item8.jpg" /></a>
      </div>
      <p></p>
    </div>
    <!-- End Second Row -->
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product_site.php?prodid=111&group=<?php echo $_GET['group']; ?>"><img src="images/fashion-work_item9.jpg" /></a>
      </div>
      <p></p>
    </div>
    <!-- End Third Row -->
