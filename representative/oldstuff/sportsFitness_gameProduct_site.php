...
<div id="container">
  ...
  <div id="contentSample">
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product_site.php?prodid=92&group=<?php echo $_GET['group']; ?>"><img src="images/sports_item7.jpg" /></a>
      </div>
      <p>Slammin!</p>
    </div>
        <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=93&group=<?php echo $_GET['group']; ?>"><img src="images/sports_item8.jpg" /></a>
      </div>
      <p>Kick Start</p>
    </div>
            <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=67&group=<?php echo $_GET['group']; ?>"><img src="images/sports_item1.jpg" /></a>
      </div>
      <p>To The Gym</p>
    </div>
