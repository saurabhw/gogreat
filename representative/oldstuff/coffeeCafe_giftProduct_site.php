...
<div id="container">
  ...
  <div id="contentSample">
    ...
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=54&group=<?php echo $_GET['group']; ?>"><img src="images/coffee_item2.jpg" /></a>
      </div>
      <p>Rise &amp; Shine</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=55&group=<?php echo $_GET['group']; ?>"><img src="images/coffee_item3.jpg" /></a>
      </div>
      <p>Coffee Comforts</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=56&group=<?php echo $_GET['group']; ?>"><img src="images/coffee_item4.jpg" /></a>
      </div>
    ...
    <div class="rightnav">
      ...
      <ul class="stumenu">
      <li><a href="coffeeCafe_giftProduct_site.php?group=<?php echo $_GET['group']; ?>">Coffee Cafe Gifts</a></li>
      <li><a href="coffeeCafe_expressProduct_site.php?group=<?php echo $_GET['group']; ?>">Express</a></li>
      <li><a href="coffeeCafe_ciderProduct_site.php?group=<?php echo $_GET['group']; ?>">Cider &amp; Cocoa Concoctions</a></li>
      <!-- <li><a href="coffeeCafe_proteinProduct_site.php?group=<?php echo $_GET['group']; ?>">Protein To-Go</a></li> -->
      </ul>
      <br>
    </div>
    ...
    <div class="productcol1">
      <div class="product">
        <a href="product_site.php?prodid=58&group=<?php echo $_GET['group']; ?>"><img src="images/coffee_item12.jpg" /></a>
      </div>
      <p>Coffee Burst</p>
    </div>
  </div>  <!--end content-->
