...
<div id="leftSideBarSample">
  ...
  <div id="contentSample">
    ...
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=74&group=<?php echo $_GET['group']; ?>"><img src="images/kids_item1.jpg" /></a>
      </div>
      <p>ABC's &amp; 123's</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=75&group=<?php echo $_GET['group']; ?>"><img src="images/kids_item2.jpg" /></a>
      </div>
      <p>First Words,<br>Colors &amp; Sizes</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=76&group=<?php echo $_GET['group']; ?>"><img src="images/kids_item3.jpg" /></a>
      </div>
      <p>Addition &amp; Subtraction</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=77&group=<?php echo $_GET['group']; ?>"><img src="images/kids_item4.jpg" /></a>
      </div>
    ...
    <div class="rightnav">
      ...
      <ul class="stumenu">
      <li><a href="creativeKids_Product.php?group=<?php echo $_GET['group']; ?>">Early Learning &amp; Arts &amp; Crafts</a></li>
      <!--<li><a href="creativeKids_wordsProduct.php?group=<?php echo $_GET['group']; ?>">First Words, Shapes, Colors &amp; Sizes</a></li>
      <li><a href="creativeKids_mathProduct.php?group=<?php echo $_GET['group']; ?>">Adding, Subtracting &amp; Multiplying</a></li>
      <li><a href="creativeKids_artsProduct.php?group=<?php echo $_GET['group']; ?>">Arts, Crafts &amp; Multi-Media Fun</a></li>
      <li><a href="creativeKids_sportsProduct.php?group=<?php echo $_GET['group']; ?>">Sports Spectacular Starter Sack</a></li> -->
      </ul>
      <br>
    </div>
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product.php?prodid=78&group=<?php echo $_GET['group']; ?>"><img src="images/kids_item5.jpg" /></a>
      </div>
      <p>Off To The Races</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=79&group=<?php echo $_GET['group']; ?>"><img src="images/kids_item6.jpg" /></a>
      </div>
      <p>Princess Power</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=80&group=<?php echo $_GET['group']; ?>"><img src="images/kids_item7.jpg" /></a>
      </div>
      <p>Bible Stories</p>
    </div>
  </div>
