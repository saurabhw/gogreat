...
<div id="leftSideBarSample">
  ...
  <div id="contentSample">
    ...
    <!--<ul class="categoriesul">
      <li><a href="happyHealthy_sugarfreeProduct.php?group=<?php echo $_GET['group']; ?>">Sugar Free</a></li>
      <li><a href="happyHealthy_naturalProduct.php?group=<?php echo $_GET['group']; ?>">Natural</a></li>
      <li><a href="happyHealthy_organicProduct.php?group=<?php echo $_GET['group']; ?>">Organic</a></li>
      <li><a href="happyHealthy_certifiedProduct.php?group=<?php echo $_GET['group']; ?>">Certified Organic</a></li>
      <li><a href="happyHealthy_proteinProduct.php?group=<?php echo $_GET['group']; ?>">Protein To-Go</a></li>
    </ul> -->
  </div>
  <!--end content-->
