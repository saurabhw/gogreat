...
<body>
<div id="container">
  <?php include '../../distributor/header1.php' ; ?>
  ...
  <div id="content">
    ...
    <div id="column1">
      ...
      <div id="leadBox">
        <div id="infoText">
          ...
          <!--end redBar1-->
          <ul>
            <li><a href="../../distributor/about.php">Who is GreatMoods?</a></li>
            <li><a href="../../distributor/program.php">What is the GreatMoods Program?</a></li>
            <li><a href="../../distributor/productLine.php">The GreatMoods Product Line</a></li>
            <li><a href="../../distributor/customers.php">Who are the GreatMoods Targeted Online Fundraising Organizations / Customers?</a></li>
            <li><a href="#">How Much Can I Make?</a> </li>
            <li><a href="../../distributor/signup.php">$ign up and $tart today</a></li>
          </ul>
        </div>
        <!--end infoText--> 
      </div>
      ...
      <p>Combining your years of experience in fundraising with our years of experience in software, consumer product design and distribution makes our business relationship a perfect fit.</p>
	...
	<img id="imgLeft" src="../../images/recruiting/elementarybooster2.jpg" width="192" height="166" alt="elementary school children">
    ...
    <div id="pcaption">GreatMoods offers fundraising opportunities for schools, religious organizations, community organizations, and more. </div>
      ...
      <p id="redtxt">Getting started as our Distributor is quick and easy: <a href="#">Click Here</a></p>
    </div>
    <!--end column2--> 
    
  </div>
  <!--end content-->
  <?php include '../../distributor/footer.php' ; ?>
</div>
<!--end container-->
