...
<div id="container">
  ...
  <ul>
    ...
    <li>What do you think the teacher/coach/minister would think of a Fundraising Program where they have absolutely no handling of any orders, cash or products?</li>
    <li>What would you, the teacher, coach, minister think of receiving cash the next day, 24/7, 365 days a year on every Gift Basket sold?  (I can tell you the first thing you will do every morning is check your PayPal account, once this starts).</li>
  ...
  <ul>
    ...
    <li>A child can sell 1 gift basket in 5 minutes online and earn the same amount of money that it would take him in selling for 3 to 4 hours door to door. </li>
  ...
  <ul>
    ...
    <li>Over a third of the Distributors I've talked to say the same 2 statements again and again.  "This is too good to be true" and "This is a no brainer".</li>
  </ul>
  ...
  <p>Still haven't made up your mind?  Click on our calculator one more time and play the "What If" game. Then ask yourself if this is not the perfect Fundraising Line of the Future for all of your Fundraising Accounts. <a href="../../GreatMoodsDistributorCalculator.php">Earnings Potential Calculator</a> [CHECK LINK]</p>
  <p><a href="#">$ign Up and get $tarted Today with GreatMoods.</a></p>
  [NEED LINK]    [link to short form 2a]
