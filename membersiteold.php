<?php
     ...
     */
      ...
      $club_name1 = addslashes($row['Dealer']);
      $club_type1 = addslashes($row['DealerDir']);
      //$goal = $row['goal2'];
      ...
      $query5 = "SELECT * FROM sample_websites WHERE club = '$club_type1'";
...
<head>
	<meta charset="UTF-8">
	<title>GreatMoods Member Website</title>
...
<div id="container">
  <div id="headerMain"> 
  	<div id="bannerwrap"><a href="http://greatmoods.com"><img id="logo2" src="../images/whitelogo.png" alt="GreatMoods Logo"></a><img id="banner" src="../<?php echo $banner_path;?>" width="1024" height="150" alt="UPLOAD YOUR BANNER HERE!" /></div>
    <div id="menuWrapper"> </div> <!--end menuWrapper-->
      ...
      <ul class="nav">
	   ...
	   <li class="examplesEdu"><a class="titleLink" href="#">School<br>Examples</a>
	    	<?php include 'includes/menu_education_examples.php'; ?>
	    </li>
	    <li class="examplesOrg"><a class="titleLink" href="#">Organization<br>Examples</a>
	    ...
	    <li class="lfborder"><a class="logintitle" href=#">My Account<br>Sign In</a>
		      ...
		      <?php
		            if(!isset($_SESSION['LOGIN']) || $_SESSION['LOGIN'] == "FALSE") {
		                ...
		                echo '<br>';
		                echo '<input class="redbutton user" name="login" type="submit" value="sign in" />';
		                echo '</form>';
		                
		            } elseif($_SESSION['LOGIN'] == "TRUE") {
		                echo '<div class="mallmenu">
		         		<div class="nav-column">';
		                echo '<h4><a href="includes/index.php">GreatMoods Homepage</a></h4>';
		         	echo '<h4><a href="'.$_SESSION['home'].'" />Login Home</a></h4>';
		         	echo '<h4><a href="'.$_SESSION['landingPage'].'">Account Home</a></h4>';
...
<div id="leftSideBar">
  	<div class="profileimgcrop"><img src="http://greatmoods.com/images/<?php echo $contact_pic;?>" class="profilepic" alt="UPLOAD YOUR PROFILE PICTURE HERE!"></div>
  	<h1><? echo $owner; ?></h1>
  	...
  	<div id="socialmediaicons">
  		...
  		<a href="fundMember/salesContact.php?group=<?php echo $_GET['group']; ?>"><i id="emailicon" class="fa fa-envelope-square" title="Email"></i></a>
  	</div>
  	
	<ul id="sideNav">
	      <li><a href="membersite.php?group=<?php echo $_GET['group']; ?>"><i class="fa fa-home navicon"></i> Fundraiser Homepage</a></li>
	      <li><a href="fundMember/fundgettingstarted11.php?group=<?php echo $_GET['group']; ?>"><i class="fa fa-desktop navicon"></i> GreatMoods<br>Program Overview</a></li>
	       <li><a href="fundMember/fundgettingstarted14.php?group=<?php echo $_GET['group']; ?>"><i class="fa fa-list-ul navicon"></i> Fundraiser Setup Steps</a></li>
	      <li><a href="fundMember/fundgettingstarted1.php?group=<?php echo $_GET['group']; ?>"><i class="fa fa-smile-o navicon"></i> About GreatMoods</a></li>
	      <li><a href="fundMember/salesContact.php?group=<?php echo $_GET['group']; ?>"><i class="fa fa-check navicon"></i> Get Started Today!<br>Contact Your Rep!</a></li>
	</ul>
	...
	<h4>Welcome,<br>Program Overview</h4>
       	<ul id="sideNav">
             <li><a href="includes/gm_mission.php" title=""><i class="fa fa-heart navicon"></i> Mission</a></li>
             <li><a href="includes/gm_program.php" title=""><i class="fa fa-list-ol navicon"></i> GreatMoods Program</a></li> 
             <li><a href="includes/gm_getStarted.php" title=""><i class="fa fa-calendar-check-o navicon"></i> Get Started Today!</a></li> 
      	</ul>
	...
	<h4>Account Administration</h4>
       	<ul id="sideNav">
            ...
            <!-- <li><a href="fundMember/goalsAchievements.php" title=""><i class="fa fa-calculator navicon"></i> Goals & Achievements</a></li>-->
             <li><a href="fundMember/fundTools.php" title=""><i class="fa fa-wrench navicon"></i> Fundraising Tools</a></li>
             <li><a href="fundMember/viewReports2.php"><i class="fa fa-dollar navicon"></i> View Reports</a></li>
             <li><a href="fundMember/emails2.php"><i class="fa fa-envelope navicon"></i> Send Emails</a></li>
             <li><a href="fundMember/contacts.php" title="Account Home"><i class="fa fa-user navicon"></i> View Contacts</a></li>  
             <li><a href="fundMember/addFriendFamily.php" title=""><i class="fa fa-plus-square navicon"></i> Add Friend & Family</a></li> 
             <li><a href="fundMember/addBusinessSupporter.php" title=""><i class="fa fa-plus-square navicon"></i> Add Business Supporter</a></li> 
             <li><a href="fundMember/addBusinessAssociate.php" title=""><i class="fa fa-plus-square navicon"></i> Add Business Associate</a></li> 
             <li><a href="fundMember/memberHome.php" title=""><i class="fa fa-pencil navicon"></i> Edit My Account</a></li>  
      	</ul>
      	';
       	} 
       	?>     
...
<div id="contentSample">
  	<div id="column1">
  		<h3 class="sample"><? echo $owner; echo'\'s&nbsp;';  echo $club_type; ?> Fundraiser</h3>
	   ...
	   <h5 id="reasons">Reasons for Our Fundraiser</h5>
	    ...
	    <div class="leader">
	          <div class="leaderimgcrop"><img src="<?php echo $leader_photo1;?>" alt="UPLOAD YOUR LEADER PICTURE HERE!" height="140px" width="140px"></div>
	      <?
			if($capTitle1 != '')
			{
	      ...
	      <div class="studentleader">
	        <div class="leaderimgcrop"><img src="<?php echo $contact_pic1;?>" alt="UPLOAD ANY PICTURE HERE!" height="140px" width="140px"></div>
	        <?
			if($capTitle2 != '')
			{
			  echo'<div class="contactinfo2">
