...
// Get all the information on which rep sold the baskets
	...
	$repquery = "SELECT * FROM Dealers WHERE loginid='$rep'"; 
...
$xml->asXML("$xmlfilename.xml");

echo '<a href = "http://www.greatmoods.com/MPC/'.$xmlfilename.'.xml">Right click and save for spreadsheet</a>';
?>