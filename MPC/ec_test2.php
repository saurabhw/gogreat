...
# ----
  ...
  $orders = internal_fetch_url_libcurl("https://app.ecwid.com/api/v3/$store_id/orders?orderNumber=122&token=secret_9e4Mf9JChLtnXBfdaqwmtnFSSBSjT6kx");
  $orders = $orders["data"];
  ...
  $rand3 = $rand1.$rand2;
       ...
       foreach($orders as $order)
       {
        ...
        $orderCreated = $order2[created];
        $subTotal = $order2[subtotalCost];
        $affiliate = $order2[affiliateId];
        $items = $order[items];
