...
<head>
<meta charset="UTF-8">
<title>Customer, Client &amp; Concierge Club | GreatMoods</title>
...
<div id="contentSample">
  	<div id="clientstore"> <!-- **Background: Store Image** -->
  		<div id="clientstoretable"><!-- CSS Table Grid -->
  			...
  			<div class="storerow"> <!-- CSS Row -->
  				...
  				<a href="#">Men's Wallets</a>
  				</span>
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> <!-- CSS Cell -->
  				<a href="funFashion_workProduct.php?group=<?php echo $_GET['group']; ?>">Designer Inspired Scarf Collection</a>
  				</span>
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  			</div>
  			<div class="storerow"> <!-- CSS Row -->
  				...
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"><a href="coffeeCafe_giftProduct.php?group=<?php echo $_GET['group']; ?>">Coffee Cafe<br>Gifts</a></span> <!-- CSS Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> <!-- CSS Cell -->
  				<a href="#">Designer Pocketbooks & Wallets</a>
  				</span>
  			</div>
  		</div>
  	</div>
