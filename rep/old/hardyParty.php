...
<div id="leftSideBarSample">
  ...
  <div id="contentSample">
    ...
    <h5>Happy, Hardy-Party Superstore Coming September 1st!</h5>
    <!--<ul class="categoriesul">
      <li><a href="coffeeCafe_giftProduct.php?group=<?php echo $groupID; ?>">Coffee Cafe Gifts</a></li>
      <li><a href="coffeeCafe_expressProduct.php?group=<?php echo $groupID; ?>">Express</a></li>
      <li><a href="coffeeCafe_ciderProduct.php?group=<?php echo $groupID; ?>">Cider &amp; Cocoa Concoctions</a></li>
      <li><a href="coffeeCafe_proteinProduct.php?group=<?php echo $groupID; ?>">Protein To-Go</a></li>
    </ul> -->
  </div>
  </div>
  <!--end content-->
