...
<html>
<head>
<title>Cider &amp; Cocoa Concotions | Coffee Cafe</title>
...
<div id="leftSideBarSample">
  ...
  <div id="contentSample">
    ...
    <div class="productcol1">
      <div class="product">
       <a href="product.php?prodid=62&group=<?php echo $_GET['group']; ?>"><img src="../images/coffee_item9.jpg" /></a>
      </div>
      <p>Cocoa Comforts</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=63&group=<?php echo $_GET['group']; ?>"><img src="../images/coffee_item10.jpg" /></a>
      </div>
