...
<div id="leftSideBarSample">
  ...
  <div id="contentSample">
    ...
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=84&group=<?php echo $groupID; ?>"><img src="../images/pet_item1.jpg" /></a>
      </div>
    ...
    <div class="rightnav">
      ...
      <ul class="stumenu">
      <li><a href="barneysPet_biscuitsProduct.php?group=<?php echo $groupID; ?>">Biscuits, Bones &amp; Playtime Fun</a></li>
      <!--<li><a href="barneysPet_struttingProduct.php?group=<?php echo $groupID; ?>">Strutting My Stuff</a></li> -->
      </ul>
      <br>
    </div>
