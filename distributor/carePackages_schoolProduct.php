...
<div id="leftSideBarSample">
  ...
  <div id="contentSample">
    ...
    <div class="productcol1">
      <div class="product">
         <a href="product.php?prodid=85&group=<?php echo $groupID; ?>"><img src="../images/carepackage_item3.jpg" /></a>
      </div>
      <p>Candy Fever</p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=57&group=<?php echo $groupID; ?>"><img src="../images/coffee_item11.jpg" /></a>
      </div>
            <p>Jump Start Your Day</p>
    </div>
    <div class="productcol1">
        <div class="product">
        <a href="product.php?prodid=64&group=<?php echo $groupID; ?>"><img src="../images/coffee_item13.jpg" /></a>
      </div>
