			...
			<div class="storerow3"> </div><!-- CSS Blank Row -->
  			<div class="storerow2"> <!-- CSS Row -->
				...
				<span class="storecell"> <!-- CSS Cell -->
  				<a href="#">Comfy<br>&amp; Cozy Loungewear</a>
  				</span>
				<span class="storecell"> <!-- CSS Cell -->
  				<a href="#">Wicking Nightgowns</a>
  				</span>
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  			...
  			<div class="storerow"> <!-- CSS Row -->
  				<span class="storecell"> <!-- CSS Cell -->
  				<a href="salonSpa_selectionsProduct.php?group=<?php echo $_GET['group']; ?>">Spa Salon Selections</a>
  				</span>
  				<span class="storecell"> <!-- CSS Cell -->
  				<a href="salonSpa_hairnailProduct.php?group=<?php echo $_GET['group']; ?>">Hair &amp; Nail Salon</a>
  				</span>
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				...
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> <!-- CSS Cell -->
  				<a href="#">Luxury Nightgown & Robe Sets</a>
  				</span>
  				<span class="storecell"> <!-- CSS Cell -->
  				<a href="#">Comfy<br>&amp; Cozy Bathrobes</a>
  				</span>
  			</div>
  		</div>
  	</div>
