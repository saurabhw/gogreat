...
<head>
<meta charset="UTF-8">
<title>Purses, Pocketbooks & Pouches | GreatMoods</title>
  	...
  	<div id="pursestore"> <!-- **Background: Store Image** -->
  		<div id="pursestoretable"><!-- CSS Table Grid -->
  			...
  			<div class="storerow"> <!-- CSS Row -->
  				<span class="storecell"><a href="#">On the Go Sports Bags & Pouches</a></span> <!-- CSS Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"><a href="#">Designer Pocketbooks & Wallets</a></span> <!-- CSS Cell -->
  			</div>
  			<div class="storerow"> <!-- CSS Row -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				
				<span class="storecell"><a href="#">Stylish Strap Purses</a></span> <!-- CSS Cell -->
  			</div>
