  	...
  	<div id="romanticstore"> <!-- **Background: Store Image** -->
  		<div id="romanticstoretable"><!-- CSS Table Grid -->
  			...
  			<div class="storerow"> <!-- CSS Row -->
  				...
  				<span class="storecell"><a href="#">Comfy Cozy Bathrobes</a></span> <!-- CSS Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"><a href="#">Romantic Nightgowns</a></span> <!-- CSS Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"><a href="#">Intimate Apparel</a></span> <!-- CSS Cell -->
