  	...
  	<div id="coffeestore"> <!-- **Background: Store Image** -->
  		<div id="coffeestoretable"><!-- CSS Table Grid -->
  			...
  			<div class="storerow"> <!-- CSS Row -->
  				...
  				<a href="coffeeCafe_giftProduct.php?group=<?php echo $_GET['group']; ?>">Coffee Cafe<br>Gifts</a>
  				</span>
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> <!-- CSS Cell -->
  				<a href="coffeeCafe_expressProduct.php?group=<?php echo $_GET['group']; ?>">Coffee Cafe<br>Express</a>
  				</span>
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> <!-- CSS Cell -->
  				<a href="coffeeCafe_ciderProduct.php?group=<?php echo $_GET['group']; ?>">Cider &amp; Cocoa<br>Concoctions</a>
  				</span>
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> <!-- CSS Cell -->
