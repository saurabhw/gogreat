  	...
  	<div id="sportstore"> <!-- **Background: Store Image** -->
  		<div id="sportstoretable"><!-- CSS Table Grid -->
  			...
  			<div class="storerow2"> <!-- CSS Row -->
  				...
  				<a href="sportsFitness_gameProduct.php?group=<?php echo $_GET['group']; ?>">Game Day Sports</a>
  				</span>
				<span class="storecell"> <!-- CSS Cell -->
  				<a href="sportsFitness_proteinProduct.php?group=<?php echo $_GET['group']; ?>">Protein<br>To-Go</a>
  				</span>
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> <!-- CSS Cell -->
  				<a href="sportsFitness_lockerProduct.php?group=<?php echo $_GET['group']; ?>">The Locker Room</a>
  				</span>
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  			</div>
  			<div class="storerow"> <!-- CSS Row -->
				...
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				...
  				<span class="storecell2"> <!-- CSS Cell -->
  				<a href="#">Active Wear<br>&amp; Accessories</a>
  				</span>
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> <!-- CSS Cell -->
  				<a href="sportsFitness_sillyProduct.php?group=<?php echo $_GET['group']; ?>">Silly<br>Sports</a>
  				</span>
  			</div>
  		</div>
  	</div>
