...
<div id="leftSideBarSample">
  ...
  <div id="contentSample">
    ...
    <h5>The Happy &amp; Healthy Shop Coming September 1st!</h5>
    <!--<ul class="categoriesul">
      <li><a href="happyHealthy_sugarfreeProduct.php?group=<?php echo $groupID; ?>">Sugar Free</a></li>
      <li><a href="happyHealthy_naturalProduct.php?group=<?php echo $groupID; ?>">Natural</a></li>
      <li><a href="happyHealthy_organicProduct.php?group=<?php echo $groupID; ?>">Organic</a></li>
      <li><a href="happyHealthy_certifiedProduct.php?group=<?php echo $groupID; ?>">Certified Organic</a></li>
      <li><a href="happyHealthy_proteinProduct.php?group=<?php echo $groupID; ?>">Protein To-Go</a></li>
    </ul> -->
  </div>
  <!--end content-->
