  ...
  <div id="contentSample">
    ...
    <div class="productcol1">
      <div class="product">
        ...
        <a href="product.php?prodid=168&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item1.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=169&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item3.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=170&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item4.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=171&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item11.jpg" /></a>
      </div>
      <p></p>
    </div>
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product.php?prodid=172&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item5.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=173&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item6.jpg" /></a>
      </div>
      <p></p>
    </div>
        <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=174&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item7.jpg" /></a>
      </div>
      <p></p>
    </div>
        <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=175&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item8.jpg" /></a>
      </div>
      <p></p>
    </div>
    <!-- End Second Row -->
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product.php?prodid=176&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item9.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=177&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item10.jpg" /></a>
      </div>
      <p></p>
    </div>
        <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=178&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item12.jpg" /></a>
      </div>
      <p></p>
    </div>
        <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=179&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item13.jpg" /></a>
      </div>
      <p></p>
    </div>
    <!-- End Third Row -->
   ...
   <!-- Fourth Row -->
    ...
    <div class="productcol2">
      <div class="product">
        <a href="product.php?prodid=193&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item14.jpg" /></a>
      </div>
      <p></p>
    </div>
    <div class="productcol1">
      <div class="product">
        <a href="product.php?prodid=194&group=<?php echo $_GET['group']; ?>"><img src="../images/jewelry-bracelet_item15.jpg" /></a>
      </div>
      <p></p>
    </div>
    </div>
