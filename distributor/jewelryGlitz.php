  	...
  	<div id="jewelrystore"> <!-- **Background: Store Image** -->
  		<div id="jewelrystoretable"><!-- CSS Table Grid -->
  			...
  			<div class="storerow2"> <!-- CSS Row -->
  				...
  				<a href="jewelryGlitz_setProduct.php?group=<?php echo $_GET['group']; ?>">Fashion Sets</a>
  				</span>
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> <!-- CSS Cell -->
  				<a href="#">Holiday Flair</a>
  				</span>
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				...
				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> <!-- CSS Cell -->
  				<a href="#">Fashion Necklaces</a>
  				</span>
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
				<span class="storecell"> <!-- CSS Cell -->
  				<a href="jewelryGlitz_braceletsProduct.php?group=<?php echo $_GET['group']; ?>">Fashion Bracelets</a>
  				</span>
  			</div>
  			<div class="storerow2"> <!-- CSS Row -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> <!-- CSS Cell -->
  				<a href="jewelryGlitz_christianProduct.php?group=<?php echo $_GET['group']; ?>">Christian Corner</a>
  				</span>
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
  				<span class="storecell"> &nbsp; </span> <!-- CSS Blank Cell -->
