...
<div id="container">
  <div id="headerMain">
  	<div id="bannerwrap"><a href="https://www.greatmoods.com"><img id="logo2" src="../images/whitelogo.png" alt="GreatMoods Logo"></a>
  	 	<img id="banner" src="../<?php echo $banner_path;?>" width="1024" height="150" alt="Store Banner Image" />
 </div>
