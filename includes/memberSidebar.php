                ...
                <img src="../<?php echo $myPic;?>" class="img-rounded img-responsive center-block profileimgcrop" alt="Profile Pic"/>
              	...
              	<h2><? 
              	 ...
              	 ?></h2>
                	...
                	<h3>Group Goal:<span style="margin-left: -16px;">$<?php echo $goal; ?><span></h3>
                	<h3>Amount Raised: <span style="margin-left: -16px;">$<?php echo getSoloSales($groupID); ?><span></h3>
           ...
           <!-- </div> --><!-- END sidenav list MY ACCOUNTS -->
            ...
            <div class="sidenavList nav nav-pills nav-stacked">
                ...
                <ul id="sidenavSection2" class="nav nav-pills nav-stacked collapse">
                    ...
                    <li><a href="welcome.php"><i class="fa fa-smile-o navicon"></i> About GreatMoods</a></li>
