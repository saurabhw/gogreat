		...
		<div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
		  ...
		  <div class="carousel-inner" role="listbox">
		    <div class="item active">
		      	<div class="banner_box" style="background: url(images/banner1.jpg) no-repeat right center;">
		    ...
		    <div class="item">
		      <div class="banner_box" style="background: url(images/newimages/images/banner1.jpg) no-repeat right center;">
				 	<div class="banner_inner">
						<div class="container">
							<div class="row">
								<div class="col-sm-12">
		  ...
		  <a class="left left_arw" href="#carousel-example-generic" role="button" data-slide="prev">
		    <img src="images/newimages/images/prev.png" alt="" />
		  </a>
		  <a class="right rt_arw" href="#carousel-example-generic" role="button" data-slide="next">
		    <img src="images/newimages/images/next.png" alt="" />
		  </a>
		</div>
	</div>
</section>
					...
					<div class="learn_box_top">
						<div class="media">
						  <div class="media-left">
						    <a href="#"><img class="media-object" src="images/top_icon1.png" alt="" /></a>
						  </div>
						  <div class="media-body">
						    <h4 class="media-heading">Start a Fundraiser!</h4>
			...
			<div class="col-sm-6">
				<div class="learn_box" id="open2">
					<div class="learn_box_top">
						<div class="media">
						  <div class="media-left">
						    <a href="#"><img class="media-object" src="images/top_icon2.png" alt="" /></a>
						  </div>
						  <div class="media-body">
						    <h4 class="media-heading">Support a Fundraiser!</h4>
...
<section class="add_banner">
	<div class="add_banner_bg" style="background: url(images/add_banner1.jpg) no-repeat 0 0;">
		<img src="images/add_banner2.jpg" alt="" class="visible-xs" />
	</div>
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<div class="media">
				  <div class="media-left">
				    <img class="media-object" src="images/mission_pic.png" alt="" />
				  </div>
				  <div class="media-body">
					...
					<div class="row">
						<div class="col-sm-6">
							<div class="fund_box">
								<div class="media">
								  <div class="media-left">
								    <img class="media-object" src="images/fund_pic1.png" alt="" />
								  </div>
								  <div class="media-body">
						...
						<div class="col-sm-6">
							<div class="fund_box">
								<div class="media">
								  <div class="media-left">
								    <img class="media-object" src="images/fund_pic2.png" alt="" />
								  </div>
								  <div class="media-body">
...
<section class="strength_sec" style="background: url(images/strength_pic.jpg) no-repeat center center;">
	<div class="container">
		<div class="row">
			<div class="col-sm-8">
				<div class="strength_left">
					<div class="media">
					  <div class="media-left">
					    <img class="media-object" src="images/strangth_icon.png" alt="" />
					  </div>
					  <div class="media-body">
			...
			<div class="col-sm-4">
				<div class="strength_rt">
					<img src="images/dresses_pic.png" alt="" />
				</div>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="mall_sec">
					...
					<div class="mall_rt">
						<img src="images/newimages/images/frame_pic.jpg" alt="" />
					</div>
				</div>
...
<section class="add_banner add_banner2">
	<div class="add_banner_bg" style="background: url(images/newimages/images/add_banner3.png) no-repeat 0 0;">
		<img src="images/newimages/images/add_banner4.jpg" alt="" class="visible-xs" />
	</div>
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				<div class="media">
				  <div class="media-left">
				    <img class="media-object" src="images/newimages/images/mission_pic2.png" alt="" />
				  </div>
				  <div class="media-body">
		...
		<div class="row">
				...
				<div class="row">
					<div class="extra_feturd_box">
						<div class="extra_feturd_icon">
							<img src="images/newimages/images/featrd_icon1.png" alt="" />
						</div>
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="row">
					<div class="extra_feturd_box">
						<div class="extra_feturd_icon">
							<img src="images/newimages/images/featrd_icon2.png" alt="" />
						</div>
						<div class="extra_feturd_txt">
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="row">
					<div class="extra_feturd_box">
						<div class="extra_feturd_icon">
							<img src="images/newimages/images/featrd_icon3.png" alt="" />
						</div>
						<div class="extra_feturd_txt">
			...
			<div class="col-md-3 col-sm-6 col-xs-6">
				<div class="row">
					<div class="extra_feturd_box">
						<div class="extra_feturd_icon">
							<img src="images/newimages/images/featrd_icon4.png" alt="" />
						</div>
						<div class="extra_feturd_txt">
