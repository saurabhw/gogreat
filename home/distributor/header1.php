...
<div id="headerMain">
  <div id="headerArc"> <a href="index.php"><img src="../images/GMlogo6.png" id="GMlogo" alt="GM Logo"   /></a>
    <?php
					if(!isset($_SESSION['LOGIN']) || $_SESSION['LOGIN'] == "FALSE") {
						echo "<span style='position: relative; top: 20px; left: 20px; '>";
						echo '<form id="log" action="logInUser.php" method="post">';
						echo '<label class="user">username: </label><input type="text" name="enter your name" id="user" value=""><br />';
                        echo '<label class="user">password: </label> <input type="password" name="password" id="password" value="" ><br />';
    ...
    <li><a href="#" class="drop">Sample Website<br/>
      ...
      <div class="dropdown_4columns"><!-- Begin 4 columns container -->
        ...
        <div class="col_1">
          ...
          <ul>
            <li><a href="../samplewebsites/club_website_TQ.php?group=10">Baseball</a></li>
