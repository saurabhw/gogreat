...
<div id="container">
  <div id="headerMain"> <img id="banner" src="<?php echo $banner_path;?>" width="1024" height="150" alt="banner placeholder" />
    ...
    <div id="mainNav">
      ...
      <!-- End 4 columns container -->
        ...
        <li><a href="fundwebsite_dist.php?group= <?php echo $_GET['group']; ?>">Setup/Edit<br/>
          Website</a></li>
        <li><a href="fundmembers_dist.php?group= <?php echo $_GET['group']; ?>">Setup/Edit<br/>
          Members</a></li>
        <li><a href="fundemails_dist.php?group= <?php echo $_GET['group']; ?>">Setup/Edit<br/>
          Emails</a></li>
  ...
  <div id="content">
    ...
    <div id="col1">
    	<br>
	<img src="../images/setup-edit_screens/setupeditwebsite1.png" width="404" height="402" alt="Setup/Edit Website Example">
	<img src="../images/setup-edit_screens/setupeditwebsite3.png" width="403" height="220" alt="Setup/Edit Website Example">
    </div> <!--end column1-->
    
    <div>
    	<br>
	<img src="../images/setup-edit_screens/setupeditwebsite2.png" width="404" height="287" alt="Setup/Edit Website Example">
	<img src="../images/setup-edit_screens/setupeditwebsite4.png" width="404" height="438" alt="Setup/Edit Website Example">
    </div> <!--end column2--> 
  </div> <!--end content-->
