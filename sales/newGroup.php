...
<div id="container">
      ...
      <div id="content">
          ...
          <form class="form" action="addClub2.php" method="post" id="myForm" name="myForm" onsubmit="return atleast_onecheckbox(event);" enctype="multipart/form-data">
...
<div class="groupcolumns">
	...
	<br><br>
	<input type="hidden" name="group" value="'.$clubID.'" >
	<input type="hidden" name="rep" value="'.$rpID.'" >
