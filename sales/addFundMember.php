<?php
	  ...
	  $user_page = "../membersite.php?group=";
		...
		$query2 .= " VALUES('$dealer','$fname','$mname','$lname','$ssn','$ad1','$ad2',  '$city','$state','$zip','$email','$phn','$face','$twt', '$repID','$phn',  '$payMail','$role', '$dealerdir', '$com', '$tt', '$gd')";
       ...
       //insert Dealer
		...
		$query3 .= " VALUES('$dealer','$dealerdir','$about','$reason','$goal','$start','$endz', '$address1', '$address2', '$ct','$st','$zp','$payMail','$banner', '$club_id', '$repID', '$goal2','$sponsor', '$signupType', '$orgType', '$email','$url','$face', '$twt','$leaderPic', '$locationPic', '$groupPic', '$email', '$banner','$pass', '$club_type')";
		...
		if($res1 && $res2 && $res3){
			...
			mysqli_query($link, $query10);
		        ...
		        $queryH = "INSERT INTO orgMembers(Title,orgFName, orgLName, orgEmail, orgPhone,orgRel, fundraiserID, fund_owner_id, repID, scID, vpID)VALUES('$tt', '$fname','$lname','$email','$phn', '$role', '$logID','$club_id', '$repID', '$userID', '$vpID')";
    ...
    */
	  ...
	  else
	  {
		...
		$query15 .= " VALUES('$dealer','$dealerdir','$about','$reason','$goal','$start','$endz', '$address1', '$address2', '$ct','$st','$zp','$payMail','$banner', '$club_id','$repID', '$goal2', '$sponsor','$signupType', '$orgType', '$foundUser', '$email','$url','$face', '$twt','$leaderPic', '$locationPic', '$groupPic', '$foundPic', '$email', '$banner','$pass' '$club_type')";
   ...
   $userID = $_SESSION['userId'];
   $query = "SELECT * FROM user_info WHERE userInfoID='$userID' and role='SC'";
