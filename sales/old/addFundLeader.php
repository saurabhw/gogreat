<?php
	...
	$resultL1 = mysqli_query($link, $leaderInsert1)or die ("couldn't execute Leader Insert 1.".mysql_error());
    ...
    */
	...
	$resultL = mysqli_query($link, $leaderInsert)or die ("couldn't execute Leader Insert.".mysql_error());
	/*
    $subject = "Hello ".$fname." ".$lname." You Are Now a Member Of ".$dealer." ".$dealerdir." Fundraiser";
    $message = "Hey ".$fname."!";
    $message .= "<br />";
