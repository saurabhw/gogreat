	  ...
	  $groupID = mysqli_real_escape_string($link, $_POST['groupid']);
		...
		if(!is_image($tmpPic)) {
	     ...
	     if($conPhoto != '')
	     {
          ...
          $query = "INSERT INTO orgCustomers (first, last, companyname, relationship, email, ext, homePhone, address, apt, city, state, zip, fundMemberID,fundGroupID, image_path, repID)VALUES('$fname', '$lname', '$cname', '$type', '$email', '$ext', '$phone', '$address1', '$address2', '$city','$state', '$zip', '$dealerID', '$groupID', '$personalPicPath', '$userID')";
      		...
      		?>
				...
				<div class="simpleTabs">
						...
						<table>
							<tr>
								<td id="td_1">
									...
									<div class="tablerow"> <!-- inputs -->
										<input id="city" type="text" name="city" maxlength="30" required>
					...
					<div class="interim-form">
						...
						<div id="row"> <!-- inputs -->
							<input id="email" type="email" name="" value="" required>
						</div> <!-- end row -->
