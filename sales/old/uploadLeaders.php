<?php
     ...
     while(($filesop = fgetcsv($handle, 1000, ",")) !== false)
      {
		...
		$query3 .= " VALUES('$dealer','$dealerdir','$about','$reason','$goal','$start','$endz', '$phone1', '$address1', '$address2', '$ct','$st','$zp','$payMail','$banner','$groupID','$repID', '$signupType', '$orgType', '$email','$url','$face', '$twt','$leaderPic', '$locationPic', '$groupPic', '$foundPic', '$email','$banner', '$password', '$club')";
		$result3 = mysqli_query($link, $query3)or die ("couldn't execute query 3.".mysql_error($link));
  ...
  $queryH = "INSERT INTO orgMembers(Title, orgFName, orgLName, orgEmail, orgPhone,orgRel, fundraiserID, fund_owner_id, repID, isLeader, scID, vpID)VALUES('$title', '$name','$surname','$email','$phone', '$role', '$logID','$groupID','$repID', '$one', '$scID', '$userID')";
	$resultH = mysqli_query($link, $queryH)or die ("couldn't execute query h.".mysql_error($link));
	  ...
	  $query2 .= "VALUES('$fname','$lname','$email','$phn', '$payMail','$role', '$title')";
		...
		$logID = $rowL['loginid'];
		  ...
		  //insert into the orgMembers table
		$queryX = "INSERT INTO orgMembers(Title, orgFName, orgLName, orgEmail, orgPhone,orgRel, fundraiserID, fund_owner_id, repID, isLeader, scID, vpID)VALUES('$title', '$fname','$lname','$email','$workPhone', '$role', '$logID','$groupID','$repID', '1', '$scID', '$userID')";
