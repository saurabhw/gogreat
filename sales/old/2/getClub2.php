<?php
 ...
 $link = connectTo();
  ...
  $r = addslashes($q);
  $sql = "SELECT * FROM Dealers WHERE Dealer = '$q'  AND Zip = '$z' AND setuppersonid = '$u'";
  $result = mysqli_query($con,$sql)or  die('Could not get Dealer info: ' . mysqli_error($con));	
      
  $getGroup = "SELECT * FROM Dealers WHERE Dealer = '$q' AND Zip = '$z' AND setuppersonid = '$u' AND isMainGroup = 1";
