<?php
      ...
      if(!isset($_SESSION['authenticated']) || $_SESSION['role'] != "SC")
       ...
       if(isset($_POST['submit']))
       {
          ...
          $name = mysqli_real_escape_string($link, $split[0]); 
          $zip = $split[1]; 
          $a1 = mysqli_real_escape_string($link, $split[2]);
          $orgID = $split[3];
...
header('Location: viewAccounts.php?page=1&rep='.$rpID);
ob_end_flush();
?>