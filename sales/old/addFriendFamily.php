<?php
     ...
     $link = connectTo();
	  ...
	  $conPicPath = "";
         ...
         $repID = mysqli_real_escape_string($link, $_POST['repid']);
		...
		if(!is_image($tmpPic)) {
	     ...
	     if($conPhoto != '')
	     {
          ...
          $query = "INSERT INTO orgCustomers (first, last, companyname, relationship, email, workPhone, address, apt, city, state, zip, fundMemberID,fundGroupID, image_path,repID)VALUES('$fname', '$lname', '$cname', '$type', '$email', '$phone', '$address1', '$address2', '$city','$state', '$zip', '$memberID', '$groupID', '$personalPicPath', '$repID')";
          $result = mysqli_query($link, $query)or die("MySQL ERROR query 1: ".mysqli_error($link));
          
          $query2 = "INSERT INTO orgContacts(Title, orgFName, orgLName, orgEmail, orgPhone, fundraiserID, fund_owner_id, org_contact_created, repID)VALUES('$cname', '$fname', '$lname', '$email', '$phone', '$memberID', '$groupID', 'today()','$repID')";
		...
		<div class="table">	
			<form class="" action="addFriendFamily.php" method="post" id="myForm" name="myForm" onsubmit="return validate();" enctype="multipart/form-data">
      		...
      		?>
						...
						<table>
							<tr>
								...
								<td id="td_2">
									...
									<div class="tablerow">
										<input id="phone" type="text" name="phone"><!--<input id="wphone2" type="text" name=""><input id="wphone3" type="text" name="">-->
					...
					<div class="interim-form">
						<div class="interim-header"><h2>Email Contact</h2></div>
						<div id="row"> <!-- titles -->
