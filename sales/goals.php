<?
   ...
   $memberResult = mysqli_query($link, $howMany)or die ("couldn't execute query members.".mysql_error());
   ...
   $resultB = mysqli_query($link, $queryB)or die ("couldn't execute query.".mysql_error());
...
<body>
	<div id="container">
		<?php include 'header.inc.php' ; ?>
		    ...
		    <h2 align="center">Fundraising Goals</h2> 
		    <br>
		    <div id="border">
		        <h3><? echo $name; ?></h3>
		    <div>
