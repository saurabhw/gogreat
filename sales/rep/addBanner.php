<?php
  ...
  if(!isset($_SESSION['authenticated']))
   ...
   $rep = $_GET['rep'];
   $query = "SELECT * FROM $table WHERE banner_path='' AND setuppersonid='$rep'";
	        ...
	        <?php   
	           while ($row = mysqli_fetch_assoc($result))
	              ...
	              echo '<div id="row">
	                  ...
	                  <a href="bannerUpload.php?rep='.$_GET['rep'].'&group='.$row['loginid'].'&name='.$row['Dealer'].'"><input id="redbutton" type="button" value="Add Banner" /></a>
	                  </div> <!-- end row -->';
