...
$link = connectTo();
$groupID = mysqli_prep($_GET["groupid"]);
$groupURL = urlencode($_GET["groupid"]);
			...
			<table>
				...
				if ($contacts_result) {
					while ($row_Info = mysqli_fetch_assoc($contacts_result)) {
						...
						<input type="hidden" name="group_info" value="' . htmlspecialchars($_GET["groupid"]) . '" />
						<input type="hidden" name="update_contact" value="' . htmlspecialchars($row_Info["orgContactID"]) . '" />
						
						<tr>
							<td><input id="fname" type="text" name="update_first" value="' . htmlspecialchars($row_Info['orgFName']) . '" /></td>
							<td><input id="lname" type="text" name="update_last" value="' . htmlspecialchars($row_Info['orgLName']) . '" /></td>
							<td><input id="title" type="text" name="update_title" value="' . htmlspecialchars($row_Info['Title']) . '" /></td>
							<td><input id="loginemail" type="text" name="update_email" value="' . htmlspecialchars($row_Info['orgEmail']) . '" /></td>
							<td><input id="phone" type="text" name="update_phone" value="' . htmlspecialchars($row_Info['orgPhone']) . '" /></td>
