	  ...
	  $conPicPath = "";
		...
		if(!is_image($tmpPic)) {
	     ...
	     if($conPhoto != '')
	     {
          ...
          $query = "INSERT INTO orgCustomers (first, last, companyname, relationship, gender, email, workPhone, ext, address, apt, city, state, zip, fundMemberID,fundGroupID, image_path, repID, title)VALUES('$fname', '$lname', '$cname', '$type', '$gd','$email', '$phone', '$ext', '$address1', '$address2', '$city','$state', '$zip', '$memberID', '$groupID', '$personalPicPath', '$repID', '$tt')";
      ...
      <div id="content">
		...
		<div class="table">	
			<form class="" action="addFriendFamily.php" method="post" id="myForm" name="myForm" onsubmit="return(validate());" enctype="multipart/form-data">
				...
				<div class="row">
				                <span id="hd_fm4">Select Representative:</span>
