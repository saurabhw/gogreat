<?php
   ...
   { 
     ...
     $query = "SELECT * FROM orgCustomers WHERE fundMemberID='$member' AND fundGroupID = '$groupid' ORDER BY last";
     ...
     {
       echo '<option value="'.$row['email'].'">'.$row['title'].' '.$row['first'].' '.$row['last'].'</option>';
     }
