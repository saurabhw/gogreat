...
if(isset($_POST['submit']))
{
	...
	**/
	...
	$query4 = "INSERT INTO $table3 (Dealer, DealerDir, Address1, Address2, City, State, Zip, ContactName, setuppersonid, signuptype, orgtype, email, website, leader_pic, group_team_pic, contact_pic, userName, firstPass, banner_path, token) VALUES ( '$groupName', '$optionArray[$i]','$address1','$address2','$city','$state','$zip','$contactFirstName','$setup_person','$type',
...
header('Location: ../viewDistributors.php');
}//post submit 
?>