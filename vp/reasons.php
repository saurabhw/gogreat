...
<div id="container">
    ...
    <h2 align="center">Edit Desciption</h2>
    
   <div id="border">
       <h3>About Your Fundraiser:</h3>
    <p>General description and information about your fundraiser:</p>
    <form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="POST" name="reasons" enctype="multipart/form-data" id="" onSubmit="return validate(this);">
   ...
   </div><?php include 'footer.php' ; ?>  <!--end distributor1-->
