	  ...
	  $groupID = mysqli_real_escape_string($link, $_POST['groupid']);
		...
		if(!is_image($tmpPic)) {
	     ...
	     if($conPhoto != '')
	     {
          ...
          $query2 = "INSERT INTO orgContacts(Title, orgFName, orgLName, orgEmail, orgPhone, fundraiserID, fund_owner_id, org_contact_created, repID)VALUES('$cname', '$fname', '$lname', '$email', '$phone', '$dealerID', '$groupID', 'now()','$rp')";
...
<div id="container">
      ...
      <div id="content">
		...
		<form class="" action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post" id="myForm" name="myForm" onsubmit="return validate();" enctype="multipart/form-data">
			<div class="table">
				<div class="row">
