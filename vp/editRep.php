<?php
  ...
  // $emx = $_SESSION['email'];
   ...
   $coord = $_GET['coord'];
   $getCoord = "SELECT * FROM user_info WHERE userInfoId = '$rp'";
   $cResult = mysqli_query($link, $getCoord)or die ("couldn't execute query coordinator.".mysql_error());
...
<div id="container">
    ...
    <div id="content">    
    <h2 align="center">Edit Account Information Below</h2>
  <div id="border">
	<div id="table">
        <form class="" action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="post" id="myForm" name="myForm" onsubmit="return validate(this);" enctype="multipart/form-data">
			...
			<!--<div class="interim-form"> --><!-- account login tab -->
				...
				<div class="interim-form"> <!-- social media tab4 -->
					...
					<div class="row"> 
						...
						<input type="url" id="fb"  name="fb" value="<? echo $row3['fbPage'];?>" placeholder="www.facebook.com/user">
					</div> <!-- end row -->
					<br>
					<div class="row"> 
						<span id="hd_tw" title="Twitter Username or Profile URL">Twitter</span>
						<input type="url" id="tw" name="twitter" value="<? echo $row3['twitter'];?>" placeholder="www.twitter.com/user">
					</div> <!-- end row -->
					<br>
					<div class="row"> 
						<span id="hd_li" title="LinkedIn Username or Profile URL">LinkedIn</span>
						<input type="url" id="li" name="lindkedin" value="<? echo $row3['linkedin'];?>" placeholder="www.linkedin.com/user">
					</div> <!-- end row -->
					<!--<div class="row"> 
			...
			<div class="interim-form">
				...
				<div class="row"> 
					...
					<img src="../<?php echo $row3['picPath']; ?>" alt="Profile Pic" />
				</div> <!-- end row -->
