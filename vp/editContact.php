...
<!DOCTYPE html>
<head>
	<title>GreatMoods | Fundraising Contacts</title>
</head>
...
<div id="container">
    ...
    <h3></h3>
     ...
     <form method="post" id="myForm" name="myForm" action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" onsubmit="return validate();" enctype="multipart/form-data">
     	<div class="table">
