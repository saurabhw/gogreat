...
<div id="container">
	...
	<h1>Edit Fundraising Group Information</h1>
         ...
         <div class="table">
         <form id="" action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="POST" name="addOrg" enctype="multipart/form-data" onSubmit="return validate(this);">
			...
			<div class="interim-form">
				...
				<br><b><p style="font-size: 18px;">User Name: <? echo $user_name;?></p></b>
				<br><b><p style="font-size: 18px;">Password: <? echo $user_pass;?></p></b>
							</div>							
                        			</td>
                        			<td id="td_2">
                        				<!--<div class="row"> <!-- title -->
				...
				<div class="interim-form"> <!-- payment tab -->
					...
					<div class="row"> <!-- input -->
						<input id="paypalemail" type="email" name="pal" value="<? echo $pal ?>">
					</div> <!-- end row -->
					<br>
