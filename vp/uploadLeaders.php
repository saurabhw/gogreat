<?php
  ...
  $queryH = "INSERT INTO orgMembers(Title, orgFName, orgLName, orgEmail, orgPhone,orgRel, fundraiserID, fund_owner_id, repID, isLeader, scID)VALUES('$titlex', '$fname','$lname','$email','$phone', '$role', '$logID','$groupID','$repID','1' ,'$scID')";
	  ...
	  $query2 .= "VALUES('$dealer', '$fname','$lname','$email', '$repID', '$phn', '$payMail','$role', '$dealerdir', '$titlex', '$user_table_id')";
        ...
        */
		...
		$logID = $rowL['loginid'];
		  ...
		  //insert into the orgMembers table
		$queryX = "INSERT INTO orgMembers(Title, orgFName, orgLName, orgEmail, orgPhone,orgRel, fundraiserID, fund_owner_id, repID, isLeader, scID)VALUES('$titlex', '$fname','$lname','$email','$phone', '$role', '$logID','$groupID','$repID', '1','$scID')";
