<?php
   ...
   {  
      echo "<br />";
      //get the parent
     $query5 = "SELECT * FROM Dealers WHERE loginid ='$member'";
     ...
     //get the leaders
     $query2 = "SELECT * FROM orgMembers WHERE fund_owner_id ='$member' AND isLeader = 1 ORDER BY orgLName";
