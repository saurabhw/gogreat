<?php
   ...
   $result2 = mysqli_query($link, $query2)or die ("couldn't execute query on query 2.".mysqli_error($link));
   ...
   $result3 = mysqli_query($link, $query3)or die ("couldn't execute query on query 3.".mysqli_error($link));
   ...
   $resultZ = mysqli_query($link, $queryZ)or die ("couldn't execute query.".mysqli_error($link));
...
<div id="container">		
	...
	<div id="content">
		...
		<form action="<?php echo htmlspecialchars(basename($_SERVER['REQUEST_URI'])); ?>" method="POST" name="myForm" enctype="multipart/form-data" id="myForm" onSubmit="return validate(this);">
		<div class="table">
			...
			<div class="interim-form"> <!-- social media tab4 -->
				...
				<div class="row"> 
					...
					<input type="url" id="fb"  name="fb" value="<? echo $fc;?>" placeholder="www.facebook.com/user">Include http://
				</div> <!-- end row -->
				<br>
				<div class="row"> 
					<span id="hd_tw" title="Twitter Username or Profile URL">Twitter</span>
					<input type="url" id="tw" name="twitter" value="<? echo $tw;?>" placeholder="www.twitter.com/user">Include http://
				</div> <!-- end row -->
				<!--<div class="row"> 
