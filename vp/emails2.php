...
<!DOCTYPE html>
<head>
	<title>Send Fundraising Emails</title>
</head>
...
<div id="container">
	<?php include 'header.inc.php' ; ?>
      <?php include 'sidenav.php' ; ?>
		...
		<h2 align="center">Send Emails to Contacts</h2>
		<br>
		<div id="border">
		...
		<form id="sendemail" class="graybackground" method="POST" action="new_Email.php">
			...
			<div class="row">
					...
					<select class="role4" name="groupid" id="groupid" onChange="fetch_select9(this.value);" required>
						<option>Select</option>
					</select>
